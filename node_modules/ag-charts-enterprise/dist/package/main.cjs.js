...
__export(main_exports, {
  AgCharts: () => import_ag_charts_community193.AgCharts,
  time: () => import_ag_charts_community193.time
});
...
// packages/ag-charts-enterprise/src/axes/angle/angleAxis.ts
var { AND: AND2, ChartAxisDirection: ChartAxisDirection3, GREATER_THAN, NUMBER: NUMBER2, UNION: UNION2, ProxyOnWrite, TextWrapper, TextUtils, Validate: Validate3 } = import_ag_charts_community4._ModuleSupport;
...
var AngleAxis = class extends import_ag_charts_community4._ModuleSupport.PolarAxis {
  ...
  createLabelNodeData(ticks, options, seriesRect) {
    ...
    const labelData = ticks.map((datum, index) => {
      ...
      let box = rotation ? tempText2.computeTransformedBBox() : tempText2.getBBox();
...
// packages/ag-charts-enterprise/src/axes/angle-category/angleCategoryAxis.ts
var { RATIO: RATIO2, OBJECT: OBJECT2, Validate: Validate4 } = import_ag_charts_community5._ModuleSupport;
...
// packages/ag-charts-enterprise/src/axes/angle-number/angleNumberAxis.ts
var { AND: AND3, Default, GREATER_THAN: GREATER_THAN2, LESS_THAN, NUMBER_OR_NAN, OBJECT: OBJECT3, Validate: Validate5 } = import_ag_charts_community7._ModuleSupport;
...
var _RadiusCrossLine = class _RadiusCrossLine extends PolarCrossLine {
  ...
  updateSectorNode(visible) {
    ...
    const padding = this.getPadding();
    const r0 = import_ag_charts_community9._Util.clamp(axisInnerRadius, innerRadius + padding, axisOuterRadius);
    const r1 = import_ag_charts_community9._Util.clamp(axisInnerRadius, outerRadius - padding, axisOuterRadius);
...
// packages/ag-charts-enterprise/src/axes/radius/radiusAxis.ts
var { ChartAxisDirection: ChartAxisDirection5, Default: Default2, Layers: Layers2, DEGREE: DEGREE2, BOOLEAN: BOOLEAN2, Validate: Validate7 } = import_ag_charts_community10._ModuleSupport;
...
// packages/ag-charts-enterprise/src/features/popover/popover.ts
var import_ag_charts_community16 = require("ag-charts-community");
var { createElement: createElement2 } = import_ag_charts_community16._ModuleSupport;
var canvasOverlay2 = "canvas-overlay";
var Popover = class extends import_ag_charts_community16._ModuleSupport.BaseModuleInstance {
  constructor(ctx, id) {
    super();
    this.ctx = ctx;
    this.anchor = void 0;
    this.removeGlobalEventListeners = void 0;
    this.moduleId = `popover-${id}`;
    this.element = ctx.domManager.addChild(canvasOverlay2, this.moduleId);
    this.element.role = "presentation";
    this.destroyFns.push(() => ctx.domManager.removeChild(canvasOverlay2, this.moduleId));
  }
  show(opts) {
    const { domManager } = this.ctx;
    const popover = createElement2("div");
    ...
    const rows = opts.items.map((item) => {
      ...
      const title = createElement2("span");
    ...
    const focusIndexDelta = (delta3) => {
      const { activeElement } = document;
      const activeIndex = rows.findIndex((element) => element.contains(activeElement));
      const nextIndex = activeIndex !== -1 ? Math.min(Math.max(activeIndex + delta3, 0), rows.length - 1) : 0;
    ...
    const windowMouseMoveEvent = (e) => {
      if (popover.contains(e.target))
        return;
      popover.focus();
    };
    window.addEventListener("mousemove", windowMouseMoveEvent);
    const windowMouseMoveDown = (e) => {
      if (e.button !== 0 || popover.contains(e.target))
        return;
      opts.onClose();
    };
  ...
  setAnchor(anchor) {
    this.anchor = anchor;
    const popover = this.element.firstElementChild;
    if (!popover)
      return;
  ...
  isChildElement(element) {
    return this.ctx.domManager.isManagedChildDOMElement(element, canvasOverlay2, this.moduleId);
  }
  updatePosition(popover, x, y) {
...
// packages/ag-charts-enterprise/src/features/text-input/textInput.ts
var { getDocument, getWindow } = import_ag_charts_community17._ModuleSupport;
var moduleId2 = "text-input";
var canvasOverlay3 = "canvas-overlay";
var TextInput = class extends import_ag_charts_community17._ModuleSupport.BaseModuleInstance {
  constructor(ctx) {
    super();
    this.ctx = ctx;
    this.layout = {
    ...
    this.element = ctx.domManager.addChild(canvasOverlay3, moduleId2);
    this.element.classList.add("ag-charts-text-input");
    this.destroyFns.push(() => ctx.domManager.removeChild(canvasOverlay3, moduleId2));
  }
  show(opts) {
    ...
    if (textArea.lastChild?.textContent != null) {
      ...
      range2.setStart(textArea.lastChild, textArea.lastChild.textContent.length);
      range2.setEnd(textArea.lastChild, textArea.lastChild.textContent.length);
  ...
  getBBox() {
    ...
    return new import_ag_charts_community17._Scene.BBox(left, top, width, height);
  }
};
...
var AnnotationType = /* @__PURE__ */ ((AnnotationType2) => {
  ...
  AnnotationType2["Callout"] = "callout" /* Callout */;
  AnnotationType2["Comment"] = "comment" /* Comment */;
  AnnotationType2["Note"] = "note" /* Note */;
  AnnotationType2["Text"] = "text" /* Text */;
...
var ANNOTATION_BUTTON_GROUPS = ["line-menu", "text-menu"];
...
var { Logger } = import_ag_charts_community19._Util;
...
var {
  ...
  Validate: Validate11
} = import_ag_charts_community20._ModuleSupport;
...
var ChannelAnnotationMiddleProperties = class extends Stroke(LineDash(Visible(BaseProperties2))) {
};
var AxisLabelProperties = class extends Stroke(LineDash(Fill(Label(Font(BaseProperties2))))) {
  constructor() {
    super(...arguments);
    this.cornerRadius = 2;
  }
...
var HandleProperties = class extends Stroke(LineDash(Fill(BaseProperties2))) {
};
function Annotation(Parent) {
  class AnnotationInternal extends Lockable(Visible(Parent)) {
    constructor() {
      ...
      this.id = import_ag_charts_community20._Util.uuid();
    }
...
function Cappable(Parent) {
  ...
  __decorateClass([
    Validate11(UNION3(["arrow", "circle"]), { optional: true })
  ], CappableInternal.prototype, "startCap", 2);
  __decorateClass([
    Validate11(UNION3(["arrow", "circle"]), { optional: true })
  ], CappableInternal.prototype, "endCap", 2);
...
function Extendable(Parent) {
  ...
  ], ExtendableInternal.prototype, "extendLeft", 2);
  __decorateClass([
    Validate11(BOOLEAN4, { optional: true })
  ], ExtendableInternal.prototype, "extendRight", 2);
...
var { STRING: STRING3, BaseProperties: BaseProperties3, Validate: Validate12 } = import_ag_charts_community21._ModuleSupport;
var TextualStartEndProperties = class extends Annotation(Line(Handle(Label(Font(BaseProperties3))))) {
  constructor() {
    super(...arguments);
    this.text = "";
    this.position = "top";
...
// packages/ag-charts-enterprise/src/features/annotations/callout/calloutProperties.ts
var { STRING: STRING4, Validate: Validate13, isObject } = import_ag_charts_community22._ModuleSupport;
var { Color: Color2 } = import_ag_charts_community22._Util;
...
var _Handle = class _Handle extends import_ag_charts_community23._Scene.Group {
  constructor() {
    super(...arguments);
    this.active = false;
    this.locked = false;
...
var _InvariantHandle = class _InvariantHandle extends Handle2 {
  constructor() {
    super();
    this.handle = new import_ag_charts_community23._Scene.Circle();
    this.glow = new import_ag_charts_community23._Scene.Circle();
...
var _UnivariantHandle = class _UnivariantHandle extends Handle2 {
  constructor() {
    super();
    this.handle = new import_ag_charts_community23._Scene.Rect();
    this.glow = new import_ag_charts_community23._Scene.Rect();
...
// packages/ag-charts-enterprise/src/features/annotations/scenes/annotationScene.ts
var { Layers: Layers3, isObject: isObject2 } = import_ag_charts_community24._ModuleSupport;
var AnnotationScene = class extends import_ag_charts_community24._Scene.Group {
  constructor() {
    super(...arguments);
  ...
  getCachedBBoxWithoutHandles() {
    return this.cachedBBoxWithoutHandles ?? import_ag_charts_community24._Scene.BBox.zero;
  }
  computeBBoxWithoutHandles() {
    this.computeTransformMatrix();
    return import_ag_charts_community24._Scene.Group.computeBBox(this.children.filter((node) => !(node instanceof Handle2)));
  }
  render(renderCtx) {
...
var { Vec2 } = import_ag_charts_community25._Util;
...
// packages/ag-charts-enterprise/src/features/annotations/scenes/textualStartEndScene.ts
var { CachedTextMeasurerPool, TextWrapper: TextWrapper2 } = import_ag_charts_community26._ModuleSupport;
var { BBox } = import_ag_charts_community26._Scene;
var { Vec2: Vec22 } = import_ag_charts_community26._Util;
var _TextualStartEndScene = class _TextualStartEndScene extends LinearScene {
  constructor() {
    super(...arguments);
    this.label = new import_ag_charts_community26._Scene.Text({ zIndex: 1 });
  ...
  setTextInputBBox(bbox) {
    ...
    this.markDirty(this, import_ag_charts_community26._Scene.RedrawType.MINOR);
  }
  ...
  getTextBBox(datum, coords) {
    ...
    const height = lineMetrics.length * (textOptions.font.fontSize * _TextualStartEndScene.LineHeight);
  ...
  dragHandle(datum, target, context) {
    ...
    const coords = Vec22.add(dragState.end, Vec22.sub(target, dragState.offset));
  ...
  updateLabel(datum, bbox, coords) {
    ...
    this.label.lineHeight = datum.fontSize * _TextualStartEndScene.LineHeight;
  }
  ...
  getHandleCoords(_datum, _bbox, coords, handle) {
    return {
  ...
  wrapText(datum, width) {
    const hasText = datum.text.length > 0;
    const text = hasText ? datum.text : datum.placeholderText ?? "";
    return width ? TextWrapper2.wrapText(text, {
  ...
  getTextOptions(datum) {
    return {
      ...
      textBaseline: datum.position == "center" ? "middle" : datum.position,
      lineHeight: _TextualStartEndScene.LineHeight
    };
  }
};
_TextualStartEndScene.LineHeight = 1.38;
var TextualStartEndScene = _TextualStartEndScene;

// packages/ag-charts-enterprise/src/features/annotations/callout/calloutScene.ts
var { drawCorner } = import_ag_charts_community27._Scene;
var CalloutScene = class extends TextualStartEndScene {
  constructor() {
    super();
    this.type = "callout" /* Callout */;
    this.shape = new import_ag_charts_community27._Scene.Path();
...
var { STRING: STRING5, BaseProperties: BaseProperties4, Validate: Validate14 } = import_ag_charts_community28._ModuleSupport;
...
// packages/ag-charts-enterprise/src/features/annotations/comment/commentProperties.ts
var { STRING: STRING6, Validate: Validate15, isObject: isObject3 } = import_ag_charts_community29._ModuleSupport;
var { Color: Color3 } = import_ag_charts_community29._Util;
...
var CommentProperties = class extends Fill(Stroke(TextualPointProperties)) {
  ...
  static is(value) {
    return isObject3(value) && value.type === "comment" /* Comment */;
  }
  getDefaultColor(colorPickerType) {
    switch (colorPickerType) {
      case `fill-color`:
...
var { CachedTextMeasurerPool: CachedTextMeasurerPool2, TextWrapper: TextWrapper3 } = import_ag_charts_community30._ModuleSupport;
var { Vec2: Vec23 } = import_ag_charts_community30._Util;
var _TextualPointScene = class _TextualPointScene extends AnnotationScene {
  constructor() {
    super(...arguments);
    this.label = new import_ag_charts_community30._Scene.Text({ zIndex: 1 });
  ...
  setTextInputBBox(bbox) {
    this.textInputBBox = bbox;
    this.markDirty(this, import_ag_charts_community30._Scene.RedrawType.MINOR);
  }
  update(datum, context) {
  ...
  drag(datum, target, context) {
    ...
    if (datum.locked || !dragState)
      return;
    const coords = Vec23.add(dragState.handle, Vec23.sub(target, dragState.offset));
    const point = invertCoords(coords, context);
    datum.x = point.x;
    datum.y = point.y;
  }
  ...
  getTextBBox(datum, coords, _context) {
    const { textInputBBox } = this;
    if (textInputBBox) {
      return new import_ag_charts_community30._Scene.BBox(coords.x, coords.y, textInputBBox.width, textInputBBox.height);
    }
    const text = this.wrapText(datum, datum.width);
    const textOptions = this.getTextOptions(datum);
    const { lineMetrics, width } = CachedTextMeasurerPool2.measureLines(text, textOptions);
    const height = lineMetrics.length * (textOptions.font.fontSize * _TextualPointScene.LineHeight);
    return new import_ag_charts_community30._Scene.BBox(coords.x, coords.y, width, height);
  }
  updateLabel(datum, bbox) {
    ...
    this.label.textBaseline = datum.position == "center" ? "middle" : datum.position;
    this.label.lineHeight = datum.fontSize * _TextualPointScene.LineHeight;
  }
  ...
  wrapText(datum, width) {
    const hasText = datum.text.length > 0;
    const text = hasText ? datum.text : datum.placeholderText ?? "";
    return width ? TextWrapper3.wrapText(text, {
      ...this.getTextOptions(datum),
      avoidOrphans: false,
      textWrap: "always",
      maxWidth: width
  ...
  getTextOptions(datum) {
    return {
      ...
      textAlign: datum.textAlign,
      textBaseline: datum.position == "center" ? "middle" : datum.position,
      lineHeight: _TextualPointScene.LineHeight
    };
  }
};
_TextualPointScene.LineHeight = 1.38;
var TextualPointScene = _TextualPointScene;

// packages/ag-charts-enterprise/src/features/annotations/comment/commentScene.ts
var { drawCorner: drawCorner2 } = import_ag_charts_community31._Scene;
var CommentScene = class _CommentScene extends TextualPointScene {
  constructor() {
    super();
    this.type = "comment" /* Comment */;
    this.shape = new import_ag_charts_community31._Scene.Path();
  ...
  updatePath(datum, bbox) {
    ...
    const top = y - height;
    const right = x + width;
    const cornerRadius = (fontSize * _CommentScene.LineHeight + verticalPadding) / 2;
    const { path } = this.shape;
    path.clear();
    path.moveTo(x, y);
...
var { STRING: STRING7, BaseProperties: BaseProperties5, Validate: Validate16, isObject: isObject4 } = import_ag_charts_community32._ModuleSupport;
var HorizontalLineProperties = class extends Annotation(
  Value(Handle(AxisLabel(Cappable(Stroke(LineDash(BaseProperties5))))))
) {
  constructor() {
    super(...arguments);
  ...
  static is(value) {
    return isObject4(value) && value.type === "horizontal-line" /* HorizontalLine */;
  }
...
var VerticalLineProperties = class extends Annotation(
  Value(Handle(AxisLabel(Cappable(Stroke(LineDash(BaseProperties5))))))
) {
  constructor() {
    super(...arguments);
  ...
  static is(value) {
    return isObject4(value) && value.type === "vertical-line" /* VerticalLine */;
  }
  isValidWithContext(context, warningPrefix) {
    return super.isValid(warningPrefix) && validateDatumValue(context, this, warningPrefix);
  }
...
var { calculateLabelTranslation, ChartAxisDirection: ChartAxisDirection7 } = import_ag_charts_community33._ModuleSupport;
var AxisLabelScene = class extends import_ag_charts_community33._Scene.Group {
  constructor() {
    super({ name: "AnnotationAxisLabelGroup" });
    this.label = new import_ag_charts_community33._Scene.Text({ zIndex: 1 });
    this.rect = new import_ag_charts_community33._Scene.Rect();
    const { label } = this;
    label.fontSize = 12;
...
var { Vec2: Vec24 } = import_ag_charts_community34._Util;
var CollidableLine = class extends import_ag_charts_community34._Scene.Line {
  constructor() {
    super(...arguments);
  ...
  updateCollisionBBox() {
    ...
    if (height % 2 === 0)
      height += 1;
    const topLeft = Vec24.from(x1, y1 - Math.floor(height / 2));
    const bottomRight = Vec24.from(x2, y2);
    const width = Vec24.distance(topLeft, bottomRight);
    this.collisionBBox = new import_ag_charts_community34._Scene.BBox(topLeft.x, topLeft.y, width, height);
  }
  isPointInPath(pointX, pointY) {
    const { collisionBBox, x1, y1, x2, y2 } = this;
    if (!collisionBBox)
      return false;
    const v1 = Vec24.from(x1, y1);
    const v2 = Vec24.from(x2, y2);
    const point = Vec24.sub(Vec24.from(pointX, pointY), v1);
    const end = Vec24.sub(v2, v1);
    const rotated = Vec24.rotate(point, Vec24.angle(point, end), v1);
    return collisionBBox.containsPoint(rotated.x, rotated.y) ?? false;
  }
};

// packages/ag-charts-enterprise/src/features/annotations/cross-line/crossLineScene.ts
var { Vec2: Vec25 } = import_ag_charts_community35._Util;
var { ChartAxisDirection: ChartAxisDirection8 } = import_ag_charts_community35._ModuleSupport;
var CrossLineScene = class extends AnnotationScene {
  ...
  drag(datum, target, context) {
    ...
    if (activeHandle) {
      ...
      coords = Vec25.add(dragState.middle, Vec25.sub(target, dragState.offset));
    } else {
      return;
    }
    const point = invertCoords(coords, context);
...
var { NUMBER: NUMBER4, STRING: STRING8, BaseProperties: BaseProperties6, Validate: Validate17, isObject: isObject5 } = import_ag_charts_community36._ModuleSupport;
var DisjointChannelProperties = class extends Annotation(Background(Line(Handle(Stroke(LineDash(BaseProperties6)))))) {
  constructor() {
    super(...arguments);
    this.type = "disjoint-channel" /* DisjointChannel */;
  }
  static is(value) {
    return isObject5(value) && value.type === "disjoint-channel" /* DisjointChannel */;
  }
  get bottom() {
    const bottom = {
    ...
    if (typeof bottom.start.y === "number" && typeof bottom.end.y === "number") {
      ...
      import_ag_charts_community36._Util.Logger.warnOnce(`Annotation [${this.type}] can only be used with a numeric y-axis.`);
    }
    return bottom;
  }
  isValidWithContext(context, warningPrefix) {
...
var ChannelScene = class extends LinearScene {
  constructor() {
    ...
    this.background = new import_ag_charts_community37._Scene.Path({ zIndex: -1 });
  }
  update(datum, context) {
...
var DisjointChannelScene = class extends ChannelScene {
  ...
  getOtherCoords(datum, topLeft, topRight, context) {
    ...
    const bottomLeft = Vec26.add(topLeft, Vec26.from(0, startHeight));
    const bottomRight = Vec26.add(topRight, Vec26.from(0, endHeight));
...
var { STRING: STRING9, BaseProperties: BaseProperties7, Validate: Validate18, isObject: isObject6 } = import_ag_charts_community39._ModuleSupport;
var LineProperties = class extends Annotation(Line(Handle(Cappable(Extendable(Stroke(LineDash(BaseProperties7))))))) {
  constructor() {
    super(...arguments);
    this.type = "line" /* Line */;
  }
  static is(value) {
    return isObject6(value) && value.type === "line" /* Line */;
  }
  isValidWithContext(context, warningPrefix) {
...
var { Layers: Layers4, TextWrapper: TextWrapper4 } = import_ag_charts_community41._ModuleSupport;
var { clamp: clamp2 } = import_ag_charts_community41._Util;
var NoteScene = class extends TextualPointScene {
  constructor() {
    super();
    this.type = "note" /* Note */;
    this.shape = new import_ag_charts_community41._Scene.Rect();
    this.iconBackground = new import_ag_charts_community41._Scene.SvgPath(
    ...
    this.iconLines = new import_ag_charts_community41._Scene.SvgPath(
    ...
    this.iconBackground.fillShadow = new import_ag_charts_community41._Scene.DropShadow();
  ...
  getTextBBox(datum, coords, context) {
    ...
    bbox.x = clamp2(datum.width / 2, bbox.x, seriesRect.width - bbox.width / 2);
    return bbox;
  }
  updateLabel(datum, bbox) {
    ...
    this.label.text = TextWrapper4.wrapText(datum.text, {
      font: {
        fontFamily: datum.fontFamily,
        fontSize: datum.fontSize,
        fontStyle: datum.fontStyle,
...
// packages/ag-charts-enterprise/src/features/annotations/note/noteProperties.ts
var { OBJECT: OBJECT5, STRING: STRING10, BaseProperties: BaseProperties8, Validate: Validate19, isObject: isObject7 } = import_ag_charts_community42._ModuleSupport;
var { clamp: clamp3 } = import_ag_charts_community42._Util;
...
var NoteProperties = class extends Fill(Stroke(TextualPointProperties)) {
  ...
  static is(value) {
    return isObject7(value) && value.type === "note" /* Note */;
  }
  getDefaultColor(colorPickerType) {
    switch (colorPickerType) {
      case `line-color`:
  ...
  getTextInputCoords(context) {
    ...
    const coords = super.getTextInputCoords(context);
    const padding = this.getPadding();
    coords.x = clamp3(width / 2, coords.x, seriesRect.width - width / 2);
...
var { NUMBER: NUMBER5, STRING: STRING11, OBJECT: OBJECT6, BaseProperties: BaseProperties9, Validate: Validate20, isObject: isObject8 } = import_ag_charts_community43._ModuleSupport;
var ParallelChannelProperties = class extends Annotation(
  Background(Line(Handle(Extendable(Stroke(LineDash(BaseProperties9))))))
) {
  constructor() {
    super(...arguments);
  ...
  get bottom() {
    ...
    if (typeof bottom.start.y === "number" && typeof bottom.end.y === "number") {
      ...
      import_ag_charts_community43._Util.Logger.warnOnce(`Annotation [${this.type}] can only be used with a numeric y-axis.`);
    }
    return bottom;
  }
  isValidWithContext(context, warningPrefix) {
...
__decorateClass([
  Validate20(OBJECT6, { optional: true })
...
var { Vec2: Vec27 } = import_ag_charts_community44._Util;
var ParallelChannelScene = class extends ChannelScene {
  constructor() {
    ...
    this.middleLine = new import_ag_charts_community44._Scene.Line();
  ...
  dragHandle(datum, target, context) {
    ...
    const invertedMoves = moves.map((move) => invertCoords(Vec27.add(handles[move].handle, offset), context));
    ...
    if ((activeHandle === "topMiddle" || activeHandle === "bottomMiddle") && datum.start.y != null) {
      const topLeft = invertCoords(Vec27.add(handles.topLeft.handle, offset), context);
  ...
  getOtherCoords(datum, topLeft, topRight, context) {
    ...
    const bottomLeft = Vec27.add(topLeft, Vec27.from(0, height));
    const bottomRight = Vec27.add(topRight, Vec27.from(0, height));
    return [bottomLeft, bottomRight];
  }
  updateLines(datum, top, bottom) {
...
var { STRING: STRING12, Validate: Validate21, isObject: isObject9 } = import_ag_charts_community45._ModuleSupport;
...
var annotationDatums = {
  // Lines
  ["line" /* Line */]: LineProperties,
  ["horizontal-line" /* HorizontalLine */]: HorizontalLineProperties,
  ["vertical-line" /* VerticalLine */]: VerticalLineProperties,
  // Channels
  ["parallel-channel" /* ParallelChannel */]: ParallelChannelProperties,
  ["disjoint-channel" /* DisjointChannel */]: DisjointChannelProperties,
  // Texts
  ["callout" /* Callout */]: CalloutProperties,
  ["comment" /* Comment */]: CommentProperties,
...
var annotationScenes = {
  // Lines
  ["line" /* Line */]: LineScene,
  ["horizontal-line" /* HorizontalLine */]: CrossLineScene,
  ["vertical-line" /* VerticalLine */]: CrossLineScene,
  // Channels
  ["disjoint-channel" /* DisjointChannel */]: DisjointChannelScene,
  ["parallel-channel" /* ParallelChannel */]: ParallelChannelScene,
  // Texts
  ["callout" /* Callout */]: CalloutScene,
  ["comment" /* Comment */]: CommentScene,
  ["note" /* Note */]: NoteScene,
  ["text" /* Text */]: TextScene
};
...
function getTypedDatum(datum) {
  if (
    // Lines
    LineProperties.is(datum) || HorizontalLineProperties.is(datum) || VerticalLineProperties.is(datum) || // Channels
    DisjointChannelProperties.is(datum) || ParallelChannelProperties.is(datum) || // Texts
    CalloutProperties.is(datum) || CommentProperties.is(datum) || NoteProperties.is(datum) || TextProperties.is(datum)
  ) {
    return datum;
  }
}
...
function setFontsize(datum, annotationType, fontSize) {
...
function setColor(datum, colorPickerType, colorOpacity, color, opacity) {
  switch (colorPickerType) {
    ...
    case `line-color`: {
      if ("stroke" in datum && !NoteProperties.is(datum))
        datum.stroke = color;
      if ("strokeOpacity" in datum && !NoteProperties.is(datum))
...
// packages/ag-charts-enterprise/src/features/annotations/states/textualStartEndState.ts
var { StateMachine } = import_ag_charts_community48._ModuleSupport;
var TextualStartEndStateMachine = class extends StateMachine {
  constructor(ctx) {
    ...
    this.debug = import_ag_charts_community48._Util.Debug.create(true, "annotations");
  }
};
...
var { StateMachine: StateMachine2 } = import_ag_charts_community50._ModuleSupport;
var TextualPointStateMachine = class extends StateMachine2 {
  constructor(ctx) {
    const actionCreate = ({ point }) => {
      const datum = this.createDatum();
    ...
    this.debug = import_ag_charts_community50._Util.Debug.create(true, "annotations");
  }
};
...
var { StateMachine: StateMachine3 } = import_ag_charts_community52._ModuleSupport;
var CrossLineStateMachine = class extends StateMachine3 {
  constructor(direction, ctx) {
    ...
    this.debug = import_ag_charts_community52._Util.Debug.create(true, "annotations");
  }
};
...
var { StateMachine: StateMachine4 } = import_ag_charts_community53._ModuleSupport;
var DisjointChannelStateMachine = class extends StateMachine4 {
  constructor(ctx) {
    const actionCreate = ({ point }) => {
    ...
    this.debug = import_ag_charts_community53._Util.Debug.create(true, "annotations");
  }
};
...
var { StateMachine: StateMachine5 } = import_ag_charts_community54._ModuleSupport;
var LineStateMachine = class extends StateMachine5 {
  constructor(ctx) {
    const actionCreate = ({ point }) => {
    ...
    this.debug = import_ag_charts_community54._Util.Debug.create(true, "annotations");
  }
};
...
var { StateMachine: StateMachine6 } = import_ag_charts_community56._ModuleSupport;
var ParallelChannelStateMachine = class extends StateMachine6 {
  constructor(ctx) {
    const actionCreate = ({ point }) => {
    ...
    this.debug = import_ag_charts_community56._Util.Debug.create(true, "annotations");
  }
};
...
// packages/ag-charts-enterprise/src/features/annotations/annotationsStateMachine.ts
var { StateMachine: StateMachine7 } = import_ag_charts_community58._ModuleSupport;
var AnnotationsStateMachine = class extends StateMachine7 {
  constructor(ctx) {
    ...
    const dragStateMachine = (isDatum, isNode) => {
      const node = getNode(isNode);
      const datum = getDatum(isDatum);
      return new class DragStateMachine extends StateMachine7 {
        constructor() {
          super("idle", {
            idle: {
              dragStart: {
          ...
          this.debug = import_ag_charts_community58._Util.Debug.create(true, "annotations");
        }
      }();
    };
    const textStateMachineContext = (type, isDatum, isNode) => ({
      ...ctx,
      create: createDatum(type),
      delete: deleteDatum,
      datum: getDatum(isDatum),
      node: getNode(isNode),
      showTextInput: () => {
        if (this.active != null)
    ...
    super("idle" /* Idle */, {
      ["idle" /* Idle */]: {
        ...
        // Lines
        ["line" /* Line */]: new LineStateMachine({
          ...ctx,
        ...
        ["horizontal-line" /* HorizontalLine */]: new CrossLineStateMachine("horizontal", {
          ...ctx,
        ...
        ["vertical-line" /* VerticalLine */]: new CrossLineStateMachine("vertical", {
          ...ctx,
        ...
        // Texts
        ["text" /* Text */]: new TextStateMachine(
          textStateMachineContext(
            "text" /* Text */,
            TextProperties.is,
            TextScene.is
          )
        ),
        ["comment" /* Comment */]: new CommentStateMachine(
          textStateMachineContext(
            "comment" /* Comment */,
        ...
        ["callout" /* Callout */]: new CalloutStateMachine(
          textStateMachineContext(
            "callout" /* Callout */,
        ...
        ["note" /* Note */]: new NoteStateMachine(
          textStateMachineContext(
            "note" /* Note */,
            NoteProperties.is,
            NoteScene.is
      ...
      ["dragging" /* Dragging */]: {
        ...
        // Lines
        ["line" /* Line */]: dragStateMachine(LineProperties.is, LineScene.is),
        ["horizontal-line" /* HorizontalLine */]: dragStateMachine(
          HorizontalLineProperties.is,
          CrossLineScene.is
        ),
        ["vertical-line" /* VerticalLine */]: dragStateMachine(
          VerticalLineProperties.is,
          CrossLineScene.is
        ),
        // Channels
        ["parallel-channel" /* ParallelChannel */]: dragStateMachine(
          ParallelChannelProperties.is,
          ParallelChannelScene.is
        ),
        ["disjoint-channel" /* DisjointChannel */]: dragStateMachine(
          DisjointChannelProperties.is,
          DisjointChannelScene.is
        ),
        // Texts
        ["text" /* Text */]: dragStateMachine(TextProperties.is, TextScene.is),
        ["comment" /* Comment */]: dragStateMachine(
          CommentProperties.is,
          CommentScene.is
        ),
        ["callout" /* Callout */]: dragStateMachine(
          CalloutProperties.is,
          CalloutScene.is
        ),
        ["note" /* Note */]: dragStateMachine(NoteProperties.is, NoteScene.is)
      },
...
var { BaseModuleInstance, InteractionState, Validate: Validate22, BOOLEAN: BOOLEAN5, createElement: createElement3, REGIONS, ChartAxisDirection: ChartAxisDirection9 } = import_ag_charts_community59._ModuleSupport;
...
var AxisButton = class extends BaseModuleInstance {
  ...
  setup() {
    ...
    const button = createElement3("button");
  ...
  updateButtonElement() {
    ...
    button.onclick = import_ag_charts_community59._ModuleSupport.makeAccessibleClickListener(button, () => this.onButtonClick(this.coords));
...
var { Vec2: Vec28 } = import_ag_charts_community60._Util;
...
__decorateClass([
  Validate23(AXIS_TYPE, { optional: true })
], AxesButtons.prototype, "axes", 2);
var Annotations = class extends import_ag_charts_community60._ModuleSupport.BaseModuleInstance {
  constructor(ctx) {
    super();
    this.ctx = ctx;
    ...
    this.container = new import_ag_charts_community60._Scene.Group({ name: "static-annotations" });
    this.annotations = new import_ag_charts_community60._Scene.Selection(
      this.container,
      this.createAnnotationScene.bind(this)
    );
    this.colorPicker = new ColorPicker(this.ctx);
    this.textSizePopover = new Popover(this.ctx, "annotations");
    this.annotationPickerPopover = new Popover(this.ctx, "text");
    ...
    this.defaultFontSizes = /* @__PURE__ */ new Map([
  ...
  setupStateMachine() {
    ...
    return new AnnotationsStateMachine({
      ...
      select: (index, previous) => {
        ...
        const node = index != null ? annotations.at(index) : void 0;
        ...
        if (index == null || index != null && index !== previous) {
          ctx.toolbarManager.updateButton("annotations", "line-menu", { icon: void 0 });
          ctx.toolbarManager.updateButton("annotations", "text-menu", { icon: void 0 });
        }
        if (node) {
          this.toggleAnnotationOptionsButtons();
      ...
      showTextInput: (active) => {
        ...
        const context = this.getAnnotationContext();
        const getTextInputCoords = () => Vec28.add(datum.getTextInputCoords(context), Vec28.required(this.seriesRect));
        this.textInput.show({
          styles,
          layout: {
            getTextInputCoords,
  ...
  onToolbarAnnotationOptionButtonPress(event) {
    ...
    switch (event.value) {
      ...
      case "text-size" /* TextSize */: {
        const fontSize = datum != null && "fontSize" in datum ? datum.fontSize : void 0;
        this.textSizePopover.show({
  ...
  onToolbarButtonPressTextMenu(event) {
    const { x, y, width } = event.rect;
    this.cancel();
    this.reset();
    this.annotationPickerPopover.setAnchor({ x: x + width + 6, y });
  ...
  onToolbarButtonPressAnnotation(event) {
    ...
    if (annotation) {
      ...
      import_ag_charts_community60._Util.Logger.errorOnce(`Can not create unknown annotation type [${event.value}], ignoring.`);
      this.update();
    }
  }
  onToolbarButtonMoved(event) {
    ...
    switch (value) {
      ...
      case "line-color" /* LineColor */:
      case "text-color" /* TextColor */: {
        const anchor = Vec28.add(groupRect, Vec28.from(0, groupRect.height + 4));
  ...
  updateToolbarColorPickerFill(colorPickerType, color, opacity) {
    if (color != null && opacity != null) {
      const { r, g, b } = import_ag_charts_community60._Util.Color.fromString(color);
      color = import_ag_charts_community60._Util.Color.fromArray([r, g, b, opacity]).toHexString();
    }
  ...
  onTextSizePopoverPress(item, datum) {
  ...
  onTextSizePopoverClose() {
    this.textSizePopover.hide();
  }
  onAnnotationsPopoverPress(event, item) {
  ...
  onLayoutComplete(event) {
    ...
    for (const axisLayout of event.axes ?? []) {
      if (axisLayout.direction === import_ag_charts_community60._ModuleSupport.ChartAxisDirection.X) {
  ...
  getAxis(axisLayout, seriesRect, button) {
    ...
    const bounds = buildBounds(new import_ag_charts_community60._Scene.BBox(0, 0, seriesRect.width, seriesRect.height), axisPosition, padding);
  ...
  onHover(event) {
    ...
    if (!context)
      return;
    const offset = Vec28.fromOffset(event);
    const point = invertCoords(Vec28.sub(offset, Vec28.required(seriesRect)), context);
  ...
  onClick(event) {
    ...
    if (!context)
      return;
    const offset = Vec28.sub(Vec28.fromOffset(event), Vec28.required(seriesRect));
  ...
  toggleAnnotationOptionsButtons() {
    ...
    toolbarManager.toggleButton("annotationOptions", "lock" /* Lock */, { visible: !locked });
    toolbarManager.toggleButton("annotationOptions", "unlock" /* Unlock */, { visible: locked });
  }
  clear() {
    this.cancel();
    this.deleteAll();
...
__decorateClass([
  import_ag_charts_community60._ModuleSupport.ObserveChanges((target, enabled) => {
    const {
...
var AnnotationsModule = {
  ...
  themeTemplate: {
    annotations: {
      // Lines
      line: {
        stroke: import_ag_charts_community61._Theme.DEFAULT_ANNOTATION_COLOR,
        strokeWidth: 2,
        strokeOpacity: 1,
        handle: {
          fill: import_ag_charts_community61._Theme.DEFAULT_ANNOTATION_HANDLE_FILL
        }
      },
      "horizontal-line": {
        stroke: import_ag_charts_community61._Theme.DEFAULT_ANNOTATION_COLOR,
        ...
        axisLabel: {
          enabled: true,
          color: "white",
          fill: import_ag_charts_community61._Theme.DEFAULT_ANNOTATION_COLOR,
          fontSize: 12,
          fontFamily: import_ag_charts_community61._Theme.DEFAULT_FONT_FAMILY
        }
      },
      "vertical-line": {
        stroke: import_ag_charts_community61._Theme.DEFAULT_ANNOTATION_COLOR,
      ...
      "disjoint-channel": {
        ...
        strokeOpacity: 1,
        background: {
          fill: import_ag_charts_community61._Theme.DEFAULT_ANNOTATION_BACKGROUND_FILL,
          fillOpacity: 0.2
        },
        handle: {
          fill: import_ag_charts_community61._Theme.DEFAULT_ANNOTATION_HANDLE_FILL
      ...
      // Texts
      callout: {
        color: import_ag_charts_community61._Theme.DEFAULT_LABEL_COLOUR,
        fontSize: 14,
        fontFamily: import_ag_charts_community61._Theme.DEFAULT_FONT_FAMILY,
        textAlign: "left",
        handle: {
      ...
      comment: {
        ...
        fill: import_ag_charts_community61._Theme.PALETTE_NEUTRAL_FILL
      },
      note: {
        color: import_ag_charts_community61._Theme.DEFAULT_TEXTBOX_COLOR,
        fill: import_ag_charts_community61._Theme.DEFAULT_ANNOTATION_COLOR,
        stroke: import_ag_charts_community61._Theme.DEFAULT_ANNOTATION_HANDLE_FILL,
        strokeWidth: 1,
        strokeOpacity: 1,
        fontSize: 14,
        fontFamily: import_ag_charts_community61._Theme.DEFAULT_FONT_FAMILY,
        ...
        background: {
          fill: import_ag_charts_community61._Theme.DEFAULT_TEXTBOX_FILL,
          stroke: import_ag_charts_community61._Theme.DEFAULT_TEXTBOX_STROKE,
          strokeWidth: 1
        }
      },
      text: {
        color: import_ag_charts_community61._Theme.DEFAULT_TEXT_ANNOTATION_COLOR,
        fontSize: 14,
        fontFamily: import_ag_charts_community61._Theme.DEFAULT_FONT_FAMILY,
        textAlign: "left",
        handle: {
...
var Image = class extends BaseProperties10 {
  constructor() {
    super();
    this.opacity = 1;
    ...
    this.imageElement = createElement4("img");
    this.imageElement.onload = this.onImageLoad;
    this.node = new import_ag_charts_community62._Scene.Image(this.imageElement);
  }
  get complete() {
...
__decorateClass([
  Validate24(NUMBER6, { optional: true })
...
__decorateClass([
  Validate24(POSITIVE_NUMBER5, { optional: true })
...
// packages/ag-charts-enterprise/src/features/background/background.ts
var { ActionOnSet, OBJECT: OBJECT7, Validate: Validate25 } = import_ag_charts_community63._ModuleSupport;
var Background2 = class extends import_ag_charts_community63._ModuleSupport.Background {
  constructor(ctx) {
    super(ctx);
    this.ctx = ctx;
  ...
  onImageLoad() {
    this.ctx.updateService.update(import_ag_charts_community63._ModuleSupport.ChartUpdateType.SCENE_RENDER);
  }
};
__decorateClass([
  Validate25(OBJECT7, { optional: true }),
  ActionOnSet({
    newValue(image) {
...
var ChartToolbar = class extends import_ag_charts_community64._ModuleSupport.BaseModuleInstance {
  constructor(ctx) {
    super();
    this.ctx = ctx;
    this.enabled = false;
    this.popover = new Popover(this.ctx, "chart-toolbar");
    this.anchor = void 0;
...
__decorateClass([
  import_ag_charts_community64._ModuleSupport.Validate(import_ag_charts_community64._ModuleSupport.BOOLEAN),
  import_ag_charts_community64._ModuleSupport.ActionOnSet({
...
// packages/ag-charts-enterprise/src/features/context-menu/contextMenu.ts
var { BOOLEAN: BOOLEAN7, Validate: Validate26, createElement: createElement5, initMenuKeyNav, makeAccessibleClickListener, ContextMenuRegistry } = import_ag_charts_community66._ModuleSupport;
var { Logger: Logger2 } = import_ag_charts_community66._Util;
var moduleId3 = "context-menu";
...
var ContextMenu = class extends import_ag_charts_community66._ModuleSupport.BaseModuleInstance {
  constructor(ctx) {
    super();
    this.ctx = ctx;
    this.enabled = true;
    ...
    const { All } = import_ag_charts_community66._ModuleSupport.InteractionState;
    ...
    this.element = ctx.domManager.addChild("canvas-overlay", moduleId3);
  ...
  show() {
    this.interactionManager.pushState(import_ag_charts_community66._ModuleSupport.InteractionState.ContextMenu);
  ...
  hide() {
    this.interactionManager.popState(import_ag_charts_community66._ModuleSupport.InteractionState.ContextMenu);
    if (this.menuElement) {
  ...
  renderMenu() {
    const menuElement = createElement5("div");
    ...
    if (ContextMenuRegistry.checkCallback("legend", type, callback)) {
      ...
      return () => {
        ...
        if (event) {
          ...
          import_ag_charts_community66._Util.Logger.error("series node not found");
        }
        this.hide();
      };
    }
  ...
  createButtonElement(type, label, callback, disabled) {
    const el = createElement5("button");
  ...
  reposition() {
    ...
    x = import_ag_charts_community66._ModuleSupport.clamp(0, x, canvasRect.width - width);
    y = import_ag_charts_community66._ModuleSupport.clamp(0, y, canvasRect.height - height);
  ...
  destroy() {
    ...
    this.ctx.domManager.removeStyles(moduleId3);
    this.ctx.domManager.removeChild("canvas-overlay", moduleId3);
  }
};
__decorateClass([
  Validate26(BOOLEAN7)
...
var ContextMenuModule = {
  ...
  themeTemplate: {
    contextMenu: {
      enabled: true,
      darkTheme: import_ag_charts_community67._Theme.IS_DARK_THEME
    }
  }
};
...
var { ActionOnSet: ActionOnSet2, BaseProperties: BaseProperties11, BOOLEAN: BOOLEAN8, FUNCTION: FUNCTION2, NUMBER: NUMBER7, STRING: STRING13, Validate: Validate27 } = import_ag_charts_community68._ModuleSupport;
var { setAttribute } = import_ag_charts_community68._Util;
var DEFAULT_LABEL_CLASS = "ag-crosshair-label";
var CrosshairLabelProperties = class extends import_ag_charts_community68._Scene.ChangeDetectableProperties {
  constructor() {
    super(...arguments);
    this.enabled = true;
    this.xOffset = 0;
...
__decorateClass([
  Validate27(STRING13, { optional: true })
...
__decorateClass([
  Validate27(FUNCTION2, { optional: true })
], CrosshairLabelProperties.prototype, "renderer", 2);
var CrosshairLabel = class extends BaseProperties11 {
  constructor(domManager) {
    super();
    this.domManager = domManager;
    this.id = import_ag_charts_community68._Util.createId(this);
    this.enabled = true;
    this.xOffset = 0;
    this.yOffset = 0;
    this.renderer = void 0;
  ...
  getBBox() {
    const { element } = this;
    return new import_ag_charts_community68._Scene.BBox(element.clientLeft, element.clientTop, element.clientWidth, element.clientHeight);
  }
  toggle(visible) {
...
// packages/ag-charts-enterprise/src/features/crosshair/crosshair.ts
var { Group: Group3, Line: Line2, BBox: BBox2 } = import_ag_charts_community69._Scene;
var { createId: createId2 } = import_ag_charts_community69._Util;
var { POSITIVE_NUMBER: POSITIVE_NUMBER6, RATIO: RATIO6, BOOLEAN: BOOLEAN9, COLOR_STRING: COLOR_STRING3, LINE_DASH: LINE_DASH3, OBJECT: OBJECT8, InteractionState: InteractionState3, Validate: Validate28, Layers: Layers5 } = import_ag_charts_community69._ModuleSupport;
var Crosshair = class extends import_ag_charts_community69._ModuleSupport.BaseModuleInstance {
  constructor(ctx) {
    super();
    this.ctx = ctx;
    ...
    this.visible = false;
    this.crosshairGroup = new Group3({
      name: "crosshairs",
      layer: true,
    ...
    this.lineGroupSelection = import_ag_charts_community69._Scene.Selection.select(this.lineGroup, Line2, false);
  ...
  onMouseMove(event) {
    ...
    this.ctx.updateService.update(import_ag_charts_community69._ModuleSupport.ChartUpdateType.SCENE_RENDER);
  }
  onMouseOut() {
    this.hideCrosshairs();
  }
...
__decorateClass([
  Validate28(COLOR_STRING3, { optional: true })
], Crosshair.prototype, "stroke", 2);
__decorateClass([
  Validate28(LINE_DASH3, { optional: true })
], Crosshair.prototype, "lineDash", 2);
__decorateClass([
  Validate28(POSITIVE_NUMBER6)
...
var CrosshairModule = {
  ...
  themeTemplate: {
    crosshair: {
      snap: true,
      stroke: import_ag_charts_community70._Theme.DEFAULT_MUTED_LABEL_COLOUR,
      strokeWidth: 1,
      strokeOpacity: 1,
      lineDash: [5, 6],
      lineDashOffset: 0,
...
var { BOOLEAN: BOOLEAN10, FUNCTION: FUNCTION3, ActionOnSet: ActionOnSet3, Validate: Validate29 } = import_ag_charts_community71._ModuleSupport;
var DataSource = class extends import_ag_charts_community71._ModuleSupport.BaseModuleInstance {
  constructor(ctx) {
    super();
    this.enabled = false;
...
var { nearestSquaredInContainer, partialAssign, mergeDefaults } = import_ag_charts_community72._ModuleSupport;
var { BBox: BBox3 } = import_ag_charts_community72._Scene;
...
var ErrorBarNode = class extends import_ag_charts_community72._Scene.Group {
  constructor() {
    super();
    this.capLength = NaN;
    this._datum = void 0;
    this.whiskerPath = new import_ag_charts_community72._Scene.Path();
    this.capsPath = new import_ag_charts_community72._Scene.Path();
...
var ErrorBarGroup = class extends import_ag_charts_community72._Scene.Group {
  get children() {
...
var ErrorBarCap = class extends BaseProperties12 {
};
__decorateClass([
  Validate30(BOOLEAN11, { optional: true })
], ErrorBarCap.prototype, "visible", 2);
__decorateClass([
  Validate30(COLOR_STRING4, { optional: true })
], ErrorBarCap.prototype, "stroke", 2);
__decorateClass([
  Validate30(POSITIVE_NUMBER7, { optional: true })
], ErrorBarCap.prototype, "strokeWidth", 2);
__decorateClass([
  Validate30(RATIO7, { optional: true })
], ErrorBarCap.prototype, "strokeOpacity", 2);
__decorateClass([
  Validate30(LINE_DASH4, { optional: true })
], ErrorBarCap.prototype, "lineDash", 2);
__decorateClass([
  Validate30(POSITIVE_NUMBER7, { optional: true })
], ErrorBarCap.prototype, "lineDashOffset", 2);
__decorateClass([
  Validate30(NUMBER8, { optional: true })
], ErrorBarCap.prototype, "length", 2);
__decorateClass([
  Validate30(RATIO7, { optional: true })
], ErrorBarCap.prototype, "lengthRatio", 2);
var ErrorBarProperties = class extends BaseProperties12 {
  constructor() {
    super(...arguments);
    this.visible = true;
    this.stroke = "black";
...
__decorateClass([
  Validate30(STRING14, { optional: true })
...
__decorateClass([
  Validate30(FUNCTION4, { optional: true })
...
function toErrorBoundCartesianSeries(ctx) {
  for (const supportedType of import_ag_charts_community74.AgErrorBarSupportedSeriesTypes) {
    if (supportedType === ctx.series.type) {
      return ctx.series;
    }
  }
  throw new Error(
    `AG Charts - unsupported series type '${ctx.series.type}', error bars supported series types: ${import_ag_charts_community74.AgErrorBarSupportedSeriesTypes.join(", ")}`
  );
}
var ErrorBars = class _ErrorBars extends import_ag_charts_community74._ModuleSupport.BaseModuleInstance {
  constructor(ctx) {
    super();
    ...
    this.groupNode = new ErrorBarGroup({
      ...
      zIndex: import_ag_charts_community74._ModuleSupport.Layers.SERIES_LAYER_ZINDEX,
      zIndexSubOrder: series.getGroupZIndexSubOrder("annotation")
    });
    annotationGroup.appendChild(this.groupNode);
    this.selection = import_ag_charts_community74._Scene.Selection.select(this.groupNode, () => this.errorBarFactory());
  ...
  static getDatumKey(datum, key, offset) {
    ...
    if (typeof value !== "number") {
      import_ag_charts_community74._Util.Logger.warnOnce(`Found [${key}] error value of type ${typeof value}. Expected number type`);
      return;
    }
    return value + offset;
  }
...
var ERROR_BARS_THEME = {
  series: {
    errorBar: {
      visible: true,
      stroke: import_ag_charts_community75._Theme.DEFAULT_LABEL_COLOUR,
      strokeWidth: 1,
      strokeOpacity: 1,
      cap: {
        length: void 0,
...
var ErrorBarsModule = {
  ...
  packageType: "enterprise",
  chartTypes: ["cartesian"],
  seriesTypes: import_ag_charts_community76.AgErrorBarSupportedSeriesTypes,
...
var { Layers: Layers6, ActionOnSet: ActionOnSet4, Validate: Validate31, ProxyPropertyOnWrite: ProxyPropertyOnWrite2, OBJECT: OBJECT10, RATIO: RATIO8, COLOR_STRING: COLOR_STRING5 } = import_ag_charts_community77._ModuleSupport;
var Foreground = class extends import_ag_charts_community77._ModuleSupport.Background {
  constructor(ctx) {
  ...
  onImageLoad() {
    this.ctx.updateService.update(import_ag_charts_community77._ModuleSupport.ChartUpdateType.SCENE_RENDER);
  }
...
__decorateClass([
  Validate31(OBJECT10, { optional: true }),
  ActionOnSet4({
    newValue(image) {
      this.node.appendChild(image.node);
      image.onLoad = () => this.onImageLoad();
...
__decorateClass([
  Validate31(COLOR_STRING5, { optional: true }),
  ProxyPropertyOnWrite2("rectNode", "fill")
], Foreground.prototype, "fill", 2);
__decorateClass([
  Validate31(RATIO8, { optional: true }),
...
var { Validate: Validate32, BOOLEAN: BOOLEAN12, POSITIVE_NUMBER: POSITIVE_NUMBER8, Layers: Layers7, ActionOnSet: ActionOnSet5, CategoryAxis, GroupedCategoryAxis, TextUtils: TextUtils2 } = import_ag_charts_community78._ModuleSupport;
var { Padding, Logger: Logger3 } = import_ag_charts_community78._Util;
var { Group: Group4, BBox: BBox4 } = import_ag_charts_community78._Scene;
...
__decorateClass([
  Validate32(POSITIVE_NUMBER8)
], MiniChartPadding.prototype, "top", 2);
__decorateClass([
  Validate32(POSITIVE_NUMBER8)
], MiniChartPadding.prototype, "bottom", 2);
var MiniChart = class extends import_ag_charts_community78._ModuleSupport.BaseModuleInstance {
  constructor(ctx) {
    super();
    this.ctx = ctx;
    this.enabled = false;
    ...
    this.seriesRoot = this.root.appendChild(
      new Group4({ name: "Series-root", layer: true, zIndex: Layers7.SERIES_LAYER_ZINDEX })
    );
...
// packages/ag-charts-enterprise/src/features/navigator/navigator.ts
var { ObserveChanges: ObserveChanges3 } = import_ag_charts_community79._ModuleSupport;
var Navigator = class extends import_ag_charts_community79._ModuleSupport.Navigator {
  constructor(ctx) {
    super(ctx);
...
var NavigatorModule = {
  ...
  themeTemplate: {
    ...import_ag_charts_community80._ModuleSupport.NavigatorModule.themeTemplate,
    navigator: {
      ...import_ag_charts_community80._ModuleSupport.NavigatorModule.themeTemplate?.navigator,
      miniChart: {
        enabled: false,
        label: {
          color: import_ag_charts_community80._Theme.DEFAULT_LABEL_COLOUR,
          fontStyle: void 0,
          fontWeight: void 0,
          fontSize: 10,
          fontFamily: import_ag_charts_community80._Theme.DEFAULT_FONT_FAMILY,
          formatter: void 0,
          padding: 0
        },
        padding: {
...
var { CachedTextMeasurerPool: CachedTextMeasurerPool3, Validate: Validate33, OBJECT: OBJECT11, BOOLEAN: BOOLEAN13, STRING: STRING15, valueProperty: valueProperty2 } = import_ag_charts_community81._ModuleSupport;
var { Label: Label2, Text: Text4, Group: Group5 } = import_ag_charts_community81._Scene;
...
var neutralColourMap = {
  hlc: "altNeutral"
};
var StatusBar = class extends import_ag_charts_community81._ModuleSupport.BaseModuleInstance {
  constructor(ctx) {
    super();
    this.ctx = ctx;
    this.enabled = false;
  ...
  startPerformLayout(opts) {
    ...
    const lineHeight = maxFontSize * Text4.defaultLineHeightRatio;
...
__decorateClass([
  Validate33(BOOLEAN13)
], StatusBar.prototype, "enabled", 2);
__decorateClass([
  Validate33(STRING15, { optional: true })
...
var StatusBarModule = {
  ...
  themeTemplate: {
    statusBar: {
      ...
      closeKey: void 0,
      volumeKey: void 0,
      layoutStyle: import_ag_charts_community82._Theme.DEFAULT_CAPTION_LAYOUT_STYLE,
      title: {
        color: import_ag_charts_community82._Theme.DEFAULT_LABEL_COLOUR
      },
      positive: {
        color: import_ag_charts_community82._Theme.PALETTE_UP_STROKE
      },
      negative: {
        color: import_ag_charts_community82._Theme.PALETTE_DOWN_STROKE
      },
      neutral: {
        color: import_ag_charts_community82._Theme.PALETTE_NEUTRAL_STROKE
      },
      altNeutral: {
        color: "gray"
      }
...
var { Logger: Logger4 } = import_ag_charts_community83._Util;
var ChartSync = class extends BaseProperties13 {
...
var { COLOR_STRING: COLOR_STRING6, RATIO: RATIO9, Validate: Validate35 } = import_ag_charts_community84._ModuleSupport;
var ZoomRect = class extends import_ag_charts_community84._Scene.Rect {
  constructor() {
    super(...arguments);
...
var { clamp: clamp4, isEqual, round } = import_ag_charts_community85._ModuleSupport;
var UNIT = { min: 0, max: 1 };
var DEFAULT_ANCHOR_POINT_X = "end";
var DEFAULT_ANCHOR_POINT_Y = "middle";
var constrain = (value, min = UNIT.min, max = UNIT.max) => clamp4(min, value, max);
...
var ZoomAxisDragger = class {
  update(event, direction, anchor, bbox, zoom, axisZoom) {
    this.oldZoom ?? (this.oldZoom = definedZoomState(
      direction === import_ag_charts_community86._ModuleSupport.ChartAxisDirection.X ? { ...zoom, x: axisZoom } : { ...zoom, y: axisZoom }
    ));
  ...
  updateZoom(direction, anchor, bbox) {
    ...
    if (!coords || !oldZoom) {
      if (direction === import_ag_charts_community86._ModuleSupport.ChartAxisDirection.X)
        return newZoom.x;
      return newZoom.y;
    }
...
var ZoomPanner = class {
  ...
  translateZooms(bbox, currentZooms, deltaX, deltaY) {
    ...
    for (const [axisId, { direction, zoom: currentZoom }] of Object.entries(currentZooms)) {
      let zoom;
      if (direction === import_ag_charts_community87._ModuleSupport.ChartAxisDirection.X) {
...
var { AND: AND5, DATE: DATE2, NUMBER: NUMBER9, OR: OR3, ActionOnSet: ActionOnSet6, isFiniteNumber: isFiniteNumber2, isValidDate, Validate: Validate36, arraysEqual: arraysEqual2 } = import_ag_charts_community88._ModuleSupport;
var ZoomRange = class {
  ...
  extendWith(fn) {
    ...
    this.start = start;
    if (!changed)
      this.onChange?.(this.axisId, this.getRange());
    return { start, end };
  }
  updateWith(fn) {
    if (!this.domain)
  ...
  updateAxis(axes) {
    ...
    const changed = this.domain == null || !arraysEqual2(this.domain, validAxisDomain);
    if (changed) {
...
var { AND: AND6, GREATER_THAN: GREATER_THAN4, LESS_THAN: LESS_THAN3, RATIO: RATIO10, ActionOnSet: ActionOnSet7, Validate: Validate37 } = import_ag_charts_community89._ModuleSupport;
var ZoomRatio = class {
  constructor(onChange) {
    this.onChange = onChange;
  }
...
__decorateClass([
  ...
  Validate37(AND6(RATIO10, LESS_THAN3("end")), { optional: true })
...
__decorateClass([
  ...
  Validate37(AND6(RATIO10, GREATER_THAN4("start")), { optional: true })
...
var ZoomScrollPanner = class {
  ...
  translateZooms(bbox, currentZooms, deltaX) {
    ...
    for (const [axisId, { direction, zoom: currentZoom }] of Object.entries(currentZooms)) {
      if (direction !== import_ag_charts_community90._ModuleSupport.ChartAxisDirection.X)
        continue;
...
var ZoomScroller = class {
  updateAxes(event, props, bbox, zooms) {
    ...
    for (const [axisId, { direction, zoom }] of Object.entries(zooms)) {
      ...
      if (direction === import_ag_charts_community91._ModuleSupport.ChartAxisDirection.X && isScalingX) {
        newZoom.max += delta3;
        newZoom = scaleZoomAxisWithAnchor(newZoom, zoom, anchorPointX, origin.x);
      } else if (direction === import_ag_charts_community91._ModuleSupport.ChartAxisDirection.Y && isScalingY) {
        newZoom.max += delta3;
...
var { ChartAxisDirection: ChartAxisDirection12, ToolbarManager: ToolbarManager2 } = import_ag_charts_community92._ModuleSupport;
...
var ZoomButtonsProperties = class extends import_ag_charts_community93._ModuleSupport.BaseProperties {
  constructor(onChange) {
    super();
    this.onChange = onChange;
    this.enabled = false;
...
__decorateClass([
  import_ag_charts_community93._ModuleSupport.ObserveChanges((target) => {
    target.onChange();
  }),
...
__decorateClass([
  ...
  Validate38(ARRAY2, { optional: true })
...
var Zoom = class extends import_ag_charts_community93._ModuleSupport.BaseModuleInstance {
  constructor(ctx) {
    super();
    this.ctx = ctx;
    this.enabled = false;
    ...
    const { Default: Default4, ZoomDrag, Animation: Animation2 } = import_ag_charts_community93._ModuleSupport.InteractionState;
  ...
  onRangeChange(direction, axisId, rangeZoom) {
    if (!axisId || !rangeZoom)
      return;
  ...
  onDragStart(event) {
    ...
    if (!enabled || !paddedRect || event.button !== 0)
      return;
  ...
  onDrag(event) {
    ...
    if (!enabled || !paddedRect || !seriesRect)
      return;
    interactionManager.pushState(import_ag_charts_community93._ModuleSupport.InteractionState.ZoomDrag);
    const zoom = this.getZoom();
    switch (dragState) {
      case 1 /* Axis */:
        if (!hoveredAxis)
        ...
        const anchor = direction === import_ag_charts_community93._ModuleSupport.ChartAxisDirection.X ? anchorPointX : anchorPointY;
  ...
  onDragEnd(_event) {
    ...
    interactionManager.popState(import_ag_charts_community93._ModuleSupport.InteractionState.ZoomDrag);
  ...
  onWheelScrolling(event) {
    ...
    if (isAxisScrolling) {
      isScalingX = hoveredAxis.direction === import_ag_charts_community93._ModuleSupport.ChartAxisDirection.X;
  ...
  onLayoutComplete(event) {
    ...
    if (!axes)
      return;
    const [axesX, axesY] = import_ag_charts_community93._Util.bifurcate((axis) => axis.direction === ChartAxisDirection13.X, axes);
...
__decorateClass([
  Validate38(BOOLEAN15, { optional: true })
...
__decorateClass([
  ...
  Validate38(OR4(RATIO11, UNION6(["off", "short", "long"], "a deceleration")))
...
var { BOOLEAN: BOOLEAN16, OBJECT: OBJECT12, POSITION, POSITIVE_NUMBER: POSITIVE_NUMBER9, BaseProperties: BaseProperties14, AxisTicks, Layers: Layers8, ProxyProperty: ProxyProperty3, Validate: Validate39 } = import_ag_charts_community94._ModuleSupport;
var { Group: Group6, Rect, LinearGradientFill, Triangle } = import_ag_charts_community94._Scene;
var { createId: createId3 } = import_ag_charts_community94._Util;
var GradientBar = class extends BaseProperties14 {
  constructor() {
    super(...arguments);
    this.thickness = 16;
...
var GradientLegend = class {
  constructor(ctx) {
    ...
    this.legendGroup = new Group6({
      name: "legend",
      layer: true,
      zIndex: Layers8.LEGEND_ZINDEX
    });
    this.gradientRect = new Rect();
    this.gradientFill = new LinearGradientFill();
    this.arrow = new Triangle();
    this.ticksGroup = new Group6({ name: "legend-axis-group" });
    this.destroyFns = [];
    this.enabled = false;
    this.position = "bottom";
...
var GradientLegendModule = {
  ...
  themeTemplate: {
    ...
    scale: {
      padding: 13,
      label: {
        color: import_ag_charts_community95._Theme.DEFAULT_LABEL_COLOUR,
        fontSize: import_ag_charts_community95._Theme.FONT_SIZE.SMALL,
        fontFamily: import_ag_charts_community95._Theme.DEFAULT_FONT_FAMILY
      },
      interval: {
        minSpacing: 1
      }
...
var LICENSING_HELP_URL = "https://charts.ag-grid.com/licensing/";
...
_LicenseManager.RELEASE_INFORMATION = "MTcyMjc4MzE2MDg0MQ==";
var LicenseManager = _LicenseManager;

// packages/ag-charts-enterprise/src/license/watermark.ts
var import_ag_charts_community96 = require("ag-charts-community");
var { createElement: createElement6 } = import_ag_charts_community96._ModuleSupport;
...
var { Group: Group7, Rect: Rect2, Line: Line3, BBox: BBox5, Selection: Selection2 } = import_ag_charts_community97._Scene;
var { Logger: Logger5 } = import_ag_charts_community97._Util;
var BoxPlotGroup = class extends Group7 {
  ...
  distanceSquared(x, y) {
    ...
    return import_ag_charts_community97._ModuleSupport.nearestSquared(x, y, nodes).distanceSquared;
  }
  get midPoint() {
    const datum = this.datum;
    if (datum.midPoint === void 0) {
      Logger5.error("BoxPlotGroup.datum.midPoint is undefined");
      return { x: NaN, y: NaN };
    }
...
__decorateClass([
  Validate40(STRING18, { optional: true })
...
__decorateClass([
  Validate40(FUNCTION5, { optional: true })
...
} = import_ag_charts_community99._ModuleSupport;
var { motion } = import_ag_charts_community99._Scene;
var { ContinuousScale } = import_ag_charts_community99._Scale;
var { Color: Color4 } = import_ag_charts_community99._Util;
var BoxPlotSeriesNodeEvent = class extends import_ag_charts_community99._ModuleSupport.SeriesNodeEvent {
...
var BoxPlotSeries = class extends import_ag_charts_community99._ModuleSupport.AbstractBarSeries {
  constructor(moduleCtx) {
    super({
      moduleCtx,
  ...
  getTooltipHtml(nodeDatum) {
    ...
    if (!xAxis || !yAxis || !this.properties.isValid())
      return import_ag_charts_community99._ModuleSupport.EMPTY_TOOLTIP_CONTENT;
    const title = import_ag_charts_community99._Util.sanitizeHtml(yName);
    const contentData = [
      [xKey, xName, xAxis],
    ...
    const content = contentData.map(([key, name, axis]) => import_ag_charts_community99._Util.sanitizeHtml(`${name ?? key}: ${axis.formatDatum(datum[key])}`)).join(title ? "<br/>" : ", ");
...
var BOX_PLOT_SERIES_THEME = {
  ...
  axes: {
    [import_ag_charts_community100._Theme.CARTESIAN_AXIS_TYPE.NUMBER]: {
      crosshair: {
        snap: false
      }
    },
    [import_ag_charts_community100._Theme.CARTESIAN_AXIS_TYPE.CATEGORY]: {
...
// packages/ag-charts-enterprise/src/series/box-plot/boxPlotModule.ts
var { Color: Color5 } = import_ag_charts_community101._Util;
var BoxPlotModule = {
  type: "series",
  optionsKey: "series[]",
  packageType: "enterprise",
  ...
  defaultAxes: [
    {
      type: import_ag_charts_community101._Theme.CARTESIAN_AXIS_TYPE.NUMBER,
      position: import_ag_charts_community101._Theme.POSITION.LEFT
    },
    {
      type: import_ag_charts_community101._Theme.CARTESIAN_AXIS_TYPE.CATEGORY,
      position: import_ag_charts_community101._Theme.POSITION.BOTTOM
    }
  ],
  themeTemplate: BOX_PLOT_SERIES_THEME,
  groupable: true,
  paletteFactory: ({ takeColors, themeTemplateParameters }) => {
    const themeBackgroundColor = themeTemplateParameters.get(import_ag_charts_community101._Theme.DEFAULT_BACKGROUND_COLOUR);
...
var TargetStyle = class extends BaseProperties16 {
  constructor() {
    super(...arguments);
    this.fill = "black";
    this.fillOpacity = 1;
...
var BulletScale = class extends BaseProperties16 {
};
__decorateClass([
  Validate41(POSITIVE_NUMBER11, { optional: true })
], BulletScale.prototype, "max", 2);
var BulletColorRange = class extends BaseProperties16 {
  constructor() {
    super(...arguments);
...
__decorateClass([
  Validate41(STRING19, { optional: true })
...
__decorateClass([
  Validate41(ARRAY3.restrict({ minLength: 0 }))
...
var { fromToMotion } = import_ag_charts_community103._Scene.motion;
var { sanitizeHtml, Color: Color6 } = import_ag_charts_community103._Util;
var STYLING_KEYS = [
  "fill",
  "fillOpacity",
  "stroke",
...
var BulletSeries = class extends import_ag_charts_community103._ModuleSupport.AbstractBarSeries {
  constructor(moduleCtx) {
    super({
      moduleCtx,
      ...
      pickModes: [
        import_ag_charts_community103._ModuleSupport.SeriesNodePickMode.NEAREST_NODE,
        import_ag_charts_community103._ModuleSupport.SeriesNodePickMode.EXACT_SHAPE_MATCH
      ],
      hasHighlightedLabels: true,
      animationResetFns: {
    ...
    this.colorRangesGroup = new import_ag_charts_community103._Scene.Group({ name: `${this.id}-colorRanges` });
    this.colorRangesSelection = import_ag_charts_community103._Scene.Selection.select(this.colorRangesGroup, import_ag_charts_community103._Scene.Rect, false);
    this.rootGroup.append(this.colorRangesGroup);
    this.targetLinesSelection = import_ag_charts_community103._Scene.Selection.select(this.annotationGroup, import_ag_charts_community103._Scene.Line, false);
  }
  destroy() {
  ...
  async createNodeData() {
    ...
    for (const { datum, values } of processedData.data) {
      ...
      if (values[0][valueIndex] < 0) {
        import_ag_charts_community103._Util.Logger.warnOnce("negative values are not supported, clipping to 0.");
      }
      ...
      const barAlongX = this.getBarDirection() === import_ag_charts_community103._ModuleSupport.ChartAxisDirection.X;
      const rect = {
      ...
      if (values[0][targetIndex] < 0) {
        import_ag_charts_community103._Util.Logger.warnOnce("negative targets are not supported, ignoring.");
      }
  ...
  nodeFactory() {
    return new import_ag_charts_community103._Scene.Rect();
  }
  async updateDatumSelection(opts) {
  ...
  async updateColorRanges() {
    ...
    const computeRect = this.getBarDirection() === import_ag_charts_community103._ModuleSupport.ChartAxisDirection.Y ? (rect, colorRange) => {
      rect.x = min;
...
var BULLET_SERIES_THEME = {
  ...
  axes: {
    [import_ag_charts_community104._Theme.CARTESIAN_AXIS_TYPE.NUMBER]: {
      nice: false,
      crosshair: {
        enabled: false
      }
...
var BulletModule = {
  ...
  defaultAxes: [
    {
      type: import_ag_charts_community105._Theme.CARTESIAN_AXIS_TYPE.NUMBER,
      position: import_ag_charts_community105._Theme.POSITION.LEFT
    },
    {
      type: import_ag_charts_community105._Theme.CARTESIAN_AXIS_TYPE.CATEGORY,
      position: import_ag_charts_community105._Theme.POSITION.BOTTOM
    }
  ],
  ...
  paletteFactory: ({ takeColors, colorsCount, themeTemplateParameters }) => {
    ...
    const themeBackgroundColor = themeTemplateParameters.get(import_ag_charts_community105._Theme.DEFAULT_BACKGROUND_COLOUR);
    const backgroundFill = (Array.isArray(themeBackgroundColor) ? themeBackgroundColor[0] : themeBackgroundColor) ?? "white";
    const targetStroke = themeTemplateParameters.get(import_ag_charts_community105._Theme.DEFAULT_CROSS_LINES_COLOUR);
    return {
      fill,
      stroke,
...
var { computeBarFocusBounds: computeBarFocusBounds3, NODE_UPDATE_STATE_TO_PHASE_MAPPING } = import_ag_charts_community106._ModuleSupport;
...
// packages/ag-charts-enterprise/src/series/ohlc/ohlcSeriesBase.ts
var { motion: motion2 } = import_ag_charts_community107._Scene;
var {
  extent: extent2,
...
} = import_ag_charts_community107._ModuleSupport;
var { sanitizeHtml: sanitizeHtml2, Logger: Logger6 } = import_ag_charts_community107._Util;
var { ContinuousScale: ContinuousScale2 } = import_ag_charts_community107._Scale;
var CandlestickSeriesNodeEvent = class extends import_ag_charts_community107._ModuleSupport.SeriesNodeEvent {
  constructor(type, nativeEvent, datum, series) {
    super(type, nativeEvent, datum, series);
    this.xKey = series.properties.xKey;
...
var OhlcSeriesBase = class extends import_ag_charts_community107._ModuleSupport.AbstractBarSeries {
  ...
  getTooltipHtml(nodeDatum) {
    ...
    const yAxis = this.getValueAxis();
    if (!xAxis || !yAxis || !this.properties.isValid())
      return import_ag_charts_community107._ModuleSupport.EMPTY_TOOLTIP_CONTENT;
...
var { SceneChangeDetection, BBox: BBox6, RedrawType } = import_ag_charts_community108._Scene;
var CandlestickBaseGroup = class extends import_ag_charts_community108._Scene.Group {
  constructor() {
    super(...arguments);
    this.x = 0;
    this.y = 0;
  ...
  distanceSquared(x, y) {
    const nodes = import_ag_charts_community108._Scene.Selection.selectByClass(this, import_ag_charts_community108._Scene.Rect, import_ag_charts_community108._Scene.Line);
    return import_ag_charts_community108._ModuleSupport.nearestSquared(x, y, nodes).distanceSquared;
  }
  get midPoint() {
    const datum = this.datum;
    if (datum.midPoint === void 0) {
      import_ag_charts_community108._Util.Logger.error("CandlestickBaseGroup.datum.midPoint is undefined");
      return { x: NaN, y: NaN };
    }
    return datum.midPoint;
  }
...
var CandlestickGroup = class extends CandlestickBaseGroup {
  constructor() {
    super();
    this.append([
      new import_ag_charts_community108._Scene.Rect({ tag: 0 /* Body */ }),
      new import_ag_charts_community108._Scene.Line({ tag: 1 /* LowWick */ }),
      new import_ag_charts_community108._Scene.Line({ tag: 2 /* HighWick */ })
    ]);
  }
  updateCoordinates() {
    const { x, y, yBottom, yHigh, yLow, width, height } = this;
    const selection = import_ag_charts_community108._Scene.Selection.select(this, import_ag_charts_community108._Scene.Rect);
...
__decorateClass([
  Validate42(STRING20, { optional: true })
...
__decorateClass([
  Validate42(FUNCTION6, { optional: true })
], CandlestickSeriesProperties.prototype, "itemStyler", 2);

// packages/ag-charts-enterprise/src/series/candlestick/candlestickSeries.ts
var { extractDecoratedProperties: extractDecoratedProperties2, mergeDefaults: mergeDefaults5 } = import_ag_charts_community110._ModuleSupport;
...
var CANDLESTICK_SERIES_THEME = {
  ...
  axes: {
    ...
    [import_ag_charts_community111._Theme.CARTESIAN_AXIS_TYPE.ORDINAL_TIME]: {
      groupPaddingInner: 0,
      crosshair: {
        enabled: true
      }
...
var CandlestickModule = {
  ...
  defaultAxes: [
    ...
    {
      type: import_ag_charts_community112._Theme.CARTESIAN_AXIS_TYPE.ORDINAL_TIME,
...
var { Logger: Logger7 } = import_ag_charts_community113._Util;
...
function removeCircularLinks(links) {
  ...
  if (circularLinks.size !== 0) {
    Logger7.warnOnce("Some links formed circular references. These will be removed from the output.");
  }
...
// packages/ag-charts-enterprise/src/series/flow-proportion/flowProportionSeries.ts
var { DataModelSeries, DataController, Validate: Validate43, ARRAY: ARRAY4, keyProperty: keyProperty4, valueProperty: valueProperty6 } = import_ag_charts_community114._ModuleSupport;
var { Selection: Selection3, Group: Group8, Text: Text5 } = import_ag_charts_community114._Scene;
var FlowProportionSeries = class extends DataModelSeries {
  constructor() {
    ...
    this.labelSelection = Selection3.select(this.labelGroup, Text5);
...
__decorateClass([
  Validate43(ARRAY4, { optional: true, property: "nodes" })
...
var { BBox: BBox7, Path: Path5, ScenePathChangeDetection } = import_ag_charts_community115._Scene;
...
var { Label: Label3 } = import_ag_charts_community116._Scene;
...
__decorateClass([
  Validate44(COLOR_STRING10, { optional: true })
...
__decorateClass([
  Validate44(FUNCTION7, { optional: true })
], ChordSeriesLinkProperties.prototype, "itemStyler", 2);
var ChordSeriesNodeProperties = class extends BaseProperties18 {
  constructor() {
    super(...arguments);
    this.spacing = 1;
    this.width = 1;
...
__decorateClass([
  Validate44(ARRAY5, { optional: true })
], ChordSeriesProperties.prototype, "nodes", 2);
__decorateClass([
  Validate44(COLOR_STRING_ARRAY)
...
// packages/ag-charts-enterprise/src/series/chord/chordSeries.ts
var { SeriesNodePickMode: SeriesNodePickMode3, CachedTextMeasurerPool: CachedTextMeasurerPool4, TextWrapper: TextWrapper5, createDatumId: createDatumId2, EMPTY_TOOLTIP_CONTENT } = import_ag_charts_community117._ModuleSupport;
var { angleBetween: angleBetween3, normalizeAngle360: normalizeAngle3605, isBetweenAngles, sanitizeHtml: sanitizeHtml3, Logger: Logger8 } = import_ag_charts_community117._Util;
var { Sector: Sector3, Text: Text6, evaluateBezier } = import_ag_charts_community117._Scene;
  ...
  async createNodeData() {
    ...
    if (this.isLabelEnabled()) {
      ...
      nodeGraph.forEach(({ datum: node }) => {
        ...
        if (label == null)
          return;
        const text = TextWrapper5.wrapText(label, {
          maxWidth: labelMaxWidth,
          font: this.properties.label,
          textWrap: "never"
        });
        const { width } = CachedTextMeasurerPool4.measureText(text, {
          font: canvasFont,
          textAlign: "left",
          textBaseline: "middle"
        });
    ...
    if (nodeCount * spacingSweep >= 2 * Math.PI || radius <= 0) {
      Logger8.warnOnce("There was insufficient space to display the Chord Series.");
      return {
        itemId: this.id,
        nodeData: [],
        labelData: []
    ...
    labelData = labelData.filter((label) => {
      const labelHeight = fontSize * Text6.defaultLineHeightRatio;
...
// packages/ag-charts-enterprise/src/series/chord/chordModule.ts
var { DEFAULT_FONT_FAMILY, DEFAULT_LABEL_COLOUR } = import_ag_charts_community118._Theme;
var ChordModule = {
  type: "series",
  optionsKey: "series[]",
  packageType: "enterprise",
...
var { CachedTextMeasurerPool: CachedTextMeasurerPool5, TextUtils: TextUtils3, TextWrapper: TextWrapper6, findMaxValue } = import_ag_charts_community119._ModuleSupport;
var { Logger: Logger9 } = import_ag_charts_community119._Util;
...
function formatStackedLabels(labelValue, labelProps, secondaryLabelValue, secondaryLabelProps, { padding }, sizeFittingHeight) {
  ...
  return findMaxValue(0, fontSizeCandidates.length - 1, (index) => {
    ...
    const labelLineHeight = TextUtils3.getLineHeight(labelFontSize);
    const secondaryLabelLineHeight = TextUtils3.getLineHeight(secondaryLabelFontSize);
...
function formatSingleLabel(value, props, { padding }, sizeFittingHeight) {
  ...
  return findMaxValue(minimumFontSize, props.fontSize, (fontSize) => {
    const lineHeight = TextUtils3.getLineHeight(fontSize);
    ...
    const lines = TextWrapper6.wrapLines(value, {
...
function formatLabels(baseLabelValue, labelProps, baseSecondaryLabelValue, secondaryLabelProps, layoutParams, sizeFittingHeight) {
  ...
  if (hasInvalidFontSize(labelProps) || hasInvalidFontSize(secondaryLabelProps)) {
    Logger9.warnOnce(`minimumFontSize should be set to a value less than or equal to the font size`);
  }
  let value;
...
function wrapLabel(text, maxWidth, maxHeight, font, textWrap, overflow) {
  const lines = TextWrapper6.wrapLines(text, { maxWidth, maxHeight, font, textWrap, overflow });
  if (!lines.length)
    return;
  const lineHeight = TextUtils3.getLineHeight(font.fontSize);
  const { width } = CachedTextMeasurerPool5.measureLines(lines, { font });
  return {
    width,
    lineHeight,
    text: lines.join("\n"),
...
function clipLines(lines, { font, lineHeight = TextUtils3.defaultLineHeight, maxWidth, maxHeight = Infinity }) {
  let height = lineHeight * lines.length;
  while (height > maxHeight) {
    if (lines.length === 1)
      return;
    lines.pop();
    lines[lines.length - 1] = TextWrapper6.appendEllipsis(lines.at(-1));
    height = lineHeight * lines.length;
  }
  const metrics = CachedTextMeasurerPool5.measureLines(lines, { font });
  let text, width;
  if (metrics.width > maxWidth) {
    ...
    text = TextWrapper6.appendEllipsis(clippedLines.join("\n"));
  } else {
    text = lines.join("\n");
    width = metrics.width;
  }
...
var { Validate: Validate45, NUMBER: NUMBER11, TEXT_WRAP, OVERFLOW_STRATEGY } = import_ag_charts_community120._ModuleSupport;
var BaseAutoSizedLabel = class extends import_ag_charts_community120._Scene.Label {
  constructor() {
    super(...arguments);
...
__decorateClass([
  Validate46(STRING22, { optional: true })
...
var { Rect: Rect3, PointerEvents } = import_ag_charts_community122._Scene;
var { ColorScale } = import_ag_charts_community122._Scale;
var { sanitizeHtml: sanitizeHtml4, Logger: Logger10 } = import_ag_charts_community122._Util;
var HeatmapSeriesNodeEvent = class extends import_ag_charts_community122._ModuleSupport.CartesianSeriesNodeEvent {
  constructor(type, nativeEvent, datum, series) {
    super(type, nativeEvent, datum, series);
...
var HeatmapSeries = class extends import_ag_charts_community122._ModuleSupport.CartesianSeries {
  constructor(moduleCtx) {
    super({
      moduleCtx,
  ...
  getTooltipHtml(nodeDatum) {
    ...
    if (!this.properties.isValid() || !xAxis || !yAxis) {
      return import_ag_charts_community122._ModuleSupport.EMPTY_TOOLTIP_CONTENT;
    }
    const {
      xKey,
      yKey,
...
var HEATMAP_SERIES_THEME = {
  series: {
    label: {
      enabled: false,
      color: import_ag_charts_community123._Theme.DEFAULT_LABEL_COLOUR,
      fontSize: import_ag_charts_community123._Theme.FONT_SIZE.SMALL,
      fontFamily: import_ag_charts_community123._Theme.DEFAULT_FONT_FAMILY,
      wrapping: "on-space",
...
var HeatmapModule = {
  ...
  defaultAxes: [
    {
      type: import_ag_charts_community124._Theme.CARTESIAN_AXIS_TYPE.CATEGORY,
      position: import_ag_charts_community124._Theme.POSITION.LEFT
    },
    {
      type: import_ag_charts_community124._Theme.CARTESIAN_AXIS_TYPE.CATEGORY,
      position: import_ag_charts_community124._Theme.POSITION.BOTTOM
    }
  ],
  themeTemplate: HEATMAP_SERIES_THEME,
  paletteFactory: ({ takeColors, colorsCount, userPalette, themeTemplateParameters }) => {
    const defaultColorRange = themeTemplateParameters.get(import_ag_charts_community124._Theme.DEFAULT_DIVERGING_SERIES_COLOUR_RANGE);
    const defaultBackgroundColor = themeTemplateParameters.get(import_ag_charts_community124._Theme.DEFAULT_BACKGROUND_COLOUR);
...
var { LonLatBBox } = import_ag_charts_community125._ModuleSupport;
...
// packages/ag-charts-enterprise/src/series/map-util/geoGeometry.ts
var { Path: Path6, ExtendedPath2D, BBox: BBox8, ScenePathChangeDetection: ScenePathChangeDetection2 } = import_ag_charts_community126._Scene;
...
function isValidCoordinate(v) {
  return Array.isArray(v) && v.length >= 2 && v.every(import_ag_charts_community127._ModuleSupport.isFiniteNumber);
}
...
var GEOJSON_OBJECT = import_ag_charts_community127._ModuleSupport.predicateWithMessage(isValidFeatureCollection, "a GeoJSON object");
...
var { COLOR_STRING: COLOR_STRING12, LINE_DASH: LINE_DASH9, OBJECT: OBJECT18, POSITIVE_NUMBER: POSITIVE_NUMBER15, RATIO: RATIO17, Validate: Validate47, SeriesProperties: SeriesProperties2, SeriesTooltip: SeriesTooltip6 } = import_ag_charts_community128._ModuleSupport;
...
// packages/ag-charts-enterprise/src/series/map-line-background/mapLineBackgroundSeries.ts
var { createDatumId: createDatumId3, DataModelSeries: DataModelSeries2, SeriesNodePickMode: SeriesNodePickMode5, Validate: Validate48 } = import_ag_charts_community129._ModuleSupport;
var { Group: Group9, Selection: Selection4, PointerEvents: PointerEvents2 } = import_ag_charts_community129._Scene;
var { Logger: Logger11 } = import_ag_charts_community129._Util;
...
__decorateClass([
  Validate48(GEOJSON_OBJECT, { optional: true, property: "topology" })
], MapLineBackgroundSeries.prototype, "_chartTopology", 2);

// packages/ag-charts-enterprise/src/series/map-line-background/mapLineBackgroundModule.ts
var { DEFAULT_HIERARCHY_STROKES } = import_ag_charts_community130._Theme;
...
var { Label: Label4 } = import_ag_charts_community131._Scene;
...
__decorateClass([
  Validate49(GEOJSON_OBJECT, { optional: true })
], MapLineSeriesProperties.prototype, "topology", 2);
__decorateClass([
  Validate49(STRING23, { optional: true })
...
var { ColorScale: ColorScale2, LinearScale: LinearScale3 } = import_ag_charts_community132._Scale;
var { Selection: Selection5, Text: Text7 } = import_ag_charts_community132._Scene;
var { sanitizeHtml: sanitizeHtml5, Logger: Logger12 } = import_ag_charts_community132._Util;
var MapLineSeries = class extends DataModelSeries3 {
  ...
  async processData(dataController) {
    ...
    if (topology == null) {
      Logger12.warnOnce(`no topology was provided for [MapLineSeries]; nothing will be rendered.`);
    }
  }
  isColorScaleValid() {
    const { colorKey } = this.properties;
  ...
  getLabelDatum(datum, labelValue, projectedGeometry, font) {
    ...
    if (labelText == null)
      return;
    const labelSize = CachedTextMeasurerPool6.measureText(String(labelText), { font });
...
__decorateClass([
  Validate50(GEOJSON_OBJECT, { optional: true, property: "topology" })
], MapLineSeries.prototype, "_chartTopology", 2);

// packages/ag-charts-enterprise/src/series/map-line/mapLineModule.ts
var { DEFAULT_DIVERGING_SERIES_COLOUR_RANGE, DEFAULT_FONT_FAMILY: DEFAULT_FONT_FAMILY2, DEFAULT_LABEL_COLOUR: DEFAULT_LABEL_COLOUR2, singleSeriesPaletteFactory } = import_ag_charts_community133._Theme;
var MapLineModule = {
  type: "series",
  optionsKey: "series[]",
  packageType: "enterprise",
...
var { Label: Label5, Circle } = import_ag_charts_community134._Scene;
var { Logger: Logger13 } = import_ag_charts_community134._Util;
var MapMarkerSeriesLabel = class extends Label5 {
  constructor() {
    super(...arguments);
...
__decorateClass([
  Validate51(GEOJSON_OBJECT, { optional: true })
], MapMarkerSeriesProperties.prototype, "topology", 2);
__decorateClass([
  Validate51(STRING24, { optional: true })
...
__decorateClass([
  Validate51(AND9(COLOR_STRING_ARRAY4, ARRAY8.restrict({ minLength: 1 })), { optional: true })
], MapMarkerSeriesProperties.prototype, "colorRange", 2);
__decorateClass([
  Validate51(MARKER_SHAPE)
], MapMarkerSeriesProperties.prototype, "shape", 2);
__decorateClass([
  Validate51(POSITIVE_NUMBER17)
], MapMarkerSeriesProperties.prototype, "size", 2);
__decorateClass([
  Validate51(POSITIVE_NUMBER17, { optional: true })
], MapMarkerSeriesProperties.prototype, "maxSize", 2);
__decorateClass([
  Validate51(NUMBER_ARRAY2, { optional: true })
], MapMarkerSeriesProperties.prototype, "sizeDomain", 2);
__decorateClass([
  Validate51(COLOR_STRING14, { optional: true })
...
__decorateClass([
  Validate51(FUNCTION10, { optional: true })
...
var { ColorScale: ColorScale3, LinearScale: LinearScale4 } = import_ag_charts_community135._Scale;
var { Group: Group10, Selection: Selection6, Text: Text8, getMarker } = import_ag_charts_community135._Scene;
var { sanitizeHtml: sanitizeHtml6, Logger: Logger14 } = import_ag_charts_community135._Util;
var MapMarkerSeries = class extends DataModelSeries4 {
  constructor(moduleCtx) {
    ...
    this.markerGroup = this.contentGroup.appendChild(
      new Group10({
        ...
        layer: true,
        isVirtual: false,
        zIndex: Layers9.SERIES_LAYER_ZINDEX,
    ...
    this.animationState = new StateMachine8(
      "empty",
      {
        empty: {
          update: {
  ...
  getLabelDatum(datum, labelValue, x, y, size, font) {
    ...
    if (labelText == null)
      return;
    const { width, height } = CachedTextMeasurerPool7.measureText(String(labelText), { font });
    return {
      point: { x, y, size },
      label: { width, height, text: labelText },
  ...
  async createNodeData() {
    ...
    if (missingGeometries.length > 0) {
      Logger14.warnOnce(`some data items do not have matches in the provided topology`, missingGeometries);
    }
    return {
      itemId: seriesId,
      nodeData,
...
__decorateClass([
  Validate52(GEOJSON_OBJECT, { optional: true, property: "topology" })
], MapMarkerSeries.prototype, "_chartTopology", 2);

// packages/ag-charts-enterprise/src/series/map-marker/mapMarkerModule.ts
var { DEFAULT_LABEL_COLOUR: DEFAULT_LABEL_COLOUR3, DEFAULT_DIVERGING_SERIES_COLOUR_RANGE: DEFAULT_DIVERGING_SERIES_COLOUR_RANGE2, singleSeriesPaletteFactory: singleSeriesPaletteFactory2 } = import_ag_charts_community136._Theme;
var MapMarkerModule = {
  type: "series",
  optionsKey: "series[]",
  packageType: "enterprise",
...
var { COLOR_STRING: COLOR_STRING15, LINE_DASH: LINE_DASH11, OBJECT: OBJECT21, POSITIVE_NUMBER: POSITIVE_NUMBER18, RATIO: RATIO20, Validate: Validate53, SeriesProperties: SeriesProperties5, SeriesTooltip: SeriesTooltip9 } = import_ag_charts_community137._ModuleSupport;
...
// packages/ag-charts-enterprise/src/series/map-shape-background/mapShapeBackgroundSeries.ts
var { createDatumId: createDatumId6, Series, SeriesNodePickMode: SeriesNodePickMode8, Validate: Validate54 } = import_ag_charts_community138._ModuleSupport;
var { Selection: Selection7, Group: Group11, PointerEvents: PointerEvents3 } = import_ag_charts_community138._Scene;
var { Logger: Logger15 } = import_ag_charts_community138._Util;
var MapShapeBackgroundSeries = class extends Series {
  ...
  async processData() {
    ...
    if (topology == null) {
      Logger15.warnOnce(`no topology was provided for [MapShapeBackgroundSeries]; nothing will be rendered.`);
    }
  }
  async createNodeData() {
    const { id: seriesId, topology, scale } = this;
  ...
  getTooltipHtml() {
    return import_ag_charts_community138._ModuleSupport.EMPTY_TOOLTIP_CONTENT;
  }
  pickFocus(_opts) {
    return void 0;
  }
...
// packages/ag-charts-enterprise/src/series/map-shape-background/mapShapeBackgroundModule.ts
var { DEFAULT_BACKGROUND_COLOUR, DEFAULT_HIERARCHY_FILLS } = import_ag_charts_community139._Theme;
...
} = import_ag_charts_community140._ModuleSupport;
...
__decorateClass([
  Validate55(AND10(COLOR_STRING_ARRAY5, ARRAY9.restrict({ minLength: 1 })), { optional: true })
...
__decorateClass([
  Validate55(POSITIVE_NUMBER19)
], MapShapeSeriesProperties.prototype, "strokeWidth", 2);
__decorateClass([
  Validate55(LINE_DASH12)
...
__decorateClass([
  Validate55(FUNCTION11, { optional: true })
...
var { ColorScale: ColorScale4 } = import_ag_charts_community141._Scale;
var { Group: Group12, Selection: Selection8, Text: Text9, PointerEvents: PointerEvents4 } = import_ag_charts_community141._Scene;
var { sanitizeHtml: sanitizeHtml7, Logger: Logger16 } = import_ag_charts_community141._Util;
var fixedScale = import_ag_charts_community141._ModuleSupport.MercatorScale.fixedScale();
var MapShapeSeries = class extends DataModelSeries5 {
  ...
  async processData(dataController) {
    ...
    if (topology == null) {
      Logger16.warnOnce(`no topology was provided for [MapShapeSeries]; nothing will be rendered.`);
    }
  }
  isColorScaleValid() {
    const { colorKey } = this.properties;
  ...
  getLabelLayout(datum, labelValue, font, geometry, previousLabelLayout) {
    ...
    if (labelText == null)
      return;
    const baseSize = CachedTextMeasurerPool8.measureText(String(labelText), { font });
  ...
  async createNodeData() {
    ...
    if (missingGeometries.length > 0) {
      Logger16.warnOnce(`some data items do not have matches in the provided topology`, missingGeometries);
    }
    return {
      itemId: seriesId,
      nodeData,
  ...
  getTooltipHtml(nodeDatum) {
    ...
    if (!processedData || !properties.isValid()) {
      return import_ag_charts_community141._ModuleSupport.EMPTY_TOOLTIP_CONTENT;
    }
    const {
      legendItemName,
      idKey,
...
} = import_ag_charts_community142._Theme;
var MapShapeModule = {
  type: "series",
  optionsKey: "series[]",
  packageType: "enterprise",
...
} = import_ag_charts_community143._ModuleSupport;
var { BandScale: BandScale3 } = import_ag_charts_community143._Scale;
var { motion: motion3 } = import_ag_charts_community143._Scene;
var { isNumber, normalizeAngle360: normalizeAngle3606, sanitizeHtml: sanitizeHtml8 } = import_ag_charts_community143._Util;
var RadialColumnSeriesNodeEvent = class extends import_ag_charts_community143._ModuleSupport.SeriesNodeEvent {
  constructor(type, nativeEvent, datum, series) {
    super(type, nativeEvent, datum, series);
...
var RadialColumnSeriesBase = class extends import_ag_charts_community143._ModuleSupport.PolarSeries {
  constructor(moduleCtx, {
    animationResetFns
  }) {
    super({
  ...
  getTooltipHtml(nodeDatum) {
    ...
    if (!this.properties.isValid() || !(xAxis && yAxis && isNumber(radiusValue)) || !dataModel) {
      return import_ag_charts_community143._ModuleSupport.EMPTY_TOOLTIP_CONTENT;
    }
...
var { Label: Label6 } = import_ag_charts_community144._Scene;
var {
...
__decorateClass([
  Validate57(STRING26, { optional: true })
...
__decorateClass([
  Validate57(FUNCTION12, { optional: true })
...
__decorateClass([
  Validate57(NUMBER12, { optional: true })
...
var { motion: motion4 } = import_ag_charts_community145._Scene;
...
// packages/ag-charts-enterprise/src/series/nightingale/nightingaleUtil.ts
var { SectorBox, motion: motion5 } = import_ag_charts_community146._Scene;
...
// packages/ag-charts-enterprise/src/series/nightingale/nightingaleSeries.ts
var { Sector: Sector4, SectorBox: SectorBox2 } = import_ag_charts_community147._Scene;
...
var NIGHTINGALE_SERIES_THEME = {
  series: {
    ...
    label: {
      enabled: false,
      fontSize: 12,
      fontFamily: import_ag_charts_community148._Theme.DEFAULT_FONT_FAMILY,
      color: import_ag_charts_community148._Theme.DEFAULT_LABEL_COLOUR
    }
  },
  axes: {
    [import_ag_charts_community148._Theme.POLAR_AXIS_TYPE.ANGLE_CATEGORY]: {
      shape: import_ag_charts_community148._Theme.POLAR_AXIS_SHAPE.CIRCLE,
      groupPaddingInner: 0,
      paddingInner: 0,
      label: {
        padding: 10
    ...
    [import_ag_charts_community148._Theme.POLAR_AXIS_TYPE.RADIUS_NUMBER]: {
      shape: import_ag_charts_community148._Theme.POLAR_AXIS_SHAPE.CIRCLE
    }
  }
};
...
var NightingaleModule = {
  ...
  defaultAxes: [
    {
      type: import_ag_charts_community149._Theme.POLAR_AXIS_TYPE.ANGLE_CATEGORY
    },
    {
      type: import_ag_charts_community149._Theme.POLAR_AXIS_TYPE.RADIUS_NUMBER
    }
  ],
  ...
  paletteFactory({ takeColors, userPalette }) {
    ...
    return {
      fill,
      stroke: userPalette !== "inbuilt" ? stroke : import_ag_charts_community149._Theme.DEFAULT_POLAR_SERIES_STROKE
    };
  },
  stackable: true,
  groupable: true,
...
var OhlcGroup = class extends CandlestickBaseGroup {
  constructor() {
    super();
    this.append([
      new import_ag_charts_community150._Scene.Line({ tag: 0 /* Body */ }),
      new import_ag_charts_community150._Scene.Line({ tag: 1 /* Open */ }),
      new import_ag_charts_community150._Scene.Line({ tag: 2 /* Close */ })
    ]);
  }
  updateCoordinates() {
    const {
    ...
    const selection = import_ag_charts_community150._Scene.Selection.select(this, import_ag_charts_community150._Scene.Rect);
    const [body] = selection.selectByTag(0 /* Body */);
...
var { BaseProperties: BaseProperties19, Validate: Validate58, COLOR_STRING: COLOR_STRING18, FUNCTION: FUNCTION13, LINE_DASH: LINE_DASH14, OBJECT: OBJECT24, POSITIVE_NUMBER: POSITIVE_NUMBER21, RATIO: RATIO23 } = import_ag_charts_community151._ModuleSupport;
...
// packages/ag-charts-enterprise/src/series/ohlc/ohlcSeries.ts
var { mergeDefaults: mergeDefaults7 } = import_ag_charts_community152._ModuleSupport;
...
var OhlcModule = {
  ...
  defaultAxes: [
    {
      type: import_ag_charts_community153._Theme.CARTESIAN_AXIS_TYPE.NUMBER,
      position: import_ag_charts_community153._Theme.POSITION.LEFT
    },
    {
      type: import_ag_charts_community153._Theme.CARTESIAN_AXIS_TYPE.ORDINAL_TIME,
      position: import_ag_charts_community153._Theme.POSITION.BOTTOM
    }
  ],
  themeTemplate: {
    animation: { enabled: false },
    axes: {
      [import_ag_charts_community153._Theme.CARTESIAN_AXIS_TYPE.NUMBER]: {
        crosshair: {
          snap: false
        }
      },
      [import_ag_charts_community153._Theme.CARTESIAN_AXIS_TYPE.ORDINAL_TIME]: {
        groupPaddingInner: 0,
        crosshair: {
          enabled: true
        }
...
var BASE_RADAR_SERIES_THEME = {
  series: {
    label: {
      enabled: false,
      fontSize: 12,
      fontFamily: import_ag_charts_community154._Theme.DEFAULT_FONT_FAMILY,
      color: import_ag_charts_community154._Theme.DEFAULT_LABEL_COLOUR
    },
    marker: {
      enabled: true,
      fillOpacity: 1,
  ...
  axes: {
    [import_ag_charts_community154._Theme.POLAR_AXIS_TYPE.ANGLE_CATEGORY]: {
      label: {
        padding: 10
      }
    }
...
var RADAR_LINE_SERIES_THEME = import_ag_charts_community154._ModuleSupport.mergeDefaults(
  {
    series: {
      strokeWidth: 2
    }
...
var RADAR_AREA_SERIES_THEME = import_ag_charts_community154._ModuleSupport.mergeDefaults(
  {
    series: {
      fillOpacity: 0.8,
      strokeWidth: 2,
...
var { Label: Label7 } = import_ag_charts_community155._Scene;
var {
  SeriesMarker,
...
var { BBox: BBox9, Group: Group13, Path: Path7, PointerEvents: PointerEvents5, Selection: Selection9, Text: Text10, getMarker: getMarker2 } = import_ag_charts_community156._Scene;
var { extent: extent3, isNumberEqual: isNumberEqual8, sanitizeHtml: sanitizeHtml9, toFixed } = import_ag_charts_community156._Util;
var RadarSeriesNodeEvent = class extends import_ag_charts_community156._ModuleSupport.SeriesNodeEvent {
  constructor(type, nativeEvent, datum, series) {
    super(type, nativeEvent, datum, series);
    this.angleKey = series.properties.angleKey;
    this.radiusKey = series.properties.radiusKey;
...
var RadarSeries = class extends import_ag_charts_community156._ModuleSupport.PolarSeries {
  constructor(moduleCtx) {
    super({
      moduleCtx,
      useLabelLayer: true,
  ...
  async createNodeData() {
    ...
    const nodeData = processedData.data.map((group) => {
      ...
      return {
        ...
        angleValue: angleDatum,
        radiusValue: radiusDatum,
        missing: !import_ag_charts_community156._Util.isNumber(angle) || !import_ag_charts_community156._Util.isNumber(radius)
      };
    });
    return { itemId: radiusKey, nodeData, labelData: nodeData };
  }
  ...
  getTooltipHtml(nodeDatum) {
    if (!this.properties.isValid()) {
      return import_ag_charts_community156._ModuleSupport.EMPTY_TOOLTIP_CONTENT;
    }
...
var { RATIO: RATIO25, COLOR_STRING: COLOR_STRING20, Validate: Validate60 } = import_ag_charts_community157._ModuleSupport;
...
// packages/ag-charts-enterprise/src/series/radar-area/radarAreaSeries.ts
var { Group: Group14, Path: Path8, PointerEvents: PointerEvents6, Selection: Selection10 } = import_ag_charts_community158._Scene;
var { ChartAxisDirection: ChartAxisDirection17 } = import_ag_charts_community158._ModuleSupport;
var RadarAreaSeries = class extends RadarSeries {
  ...
  getAreaPoints() {
    ...
    const getPolarAxis = (direction) => {
      ...
      return axis instanceof import_ag_charts_community158._ModuleSupport.PolarAxis ? axis : void 0;
    };
...
// packages/ag-charts-enterprise/src/series/radar-area/radarAreaModule.ts
var { markerPaletteFactory } = import_ag_charts_community159._ModuleSupport;
var RadarAreaModule = {
  type: "series",
  optionsKey: "series[]",
  packageType: "enterprise",
  ...
  defaultAxes: [
    {
      type: import_ag_charts_community159._Theme.POLAR_AXIS_TYPE.ANGLE_CATEGORY
    },
    {
      type: import_ag_charts_community159._Theme.POLAR_AXIS_TYPE.RADIUS_NUMBER
    }
  ],
...
var RadarLineModule = {
  ...
  defaultAxes: [
    {
      type: import_ag_charts_community160._Theme.POLAR_AXIS_TYPE.ANGLE_CATEGORY
    },
    {
      type: import_ag_charts_community160._Theme.POLAR_AXIS_TYPE.RADIUS_NUMBER
    }
  ],
...
var { Label: Label8 } = import_ag_charts_community161._Scene;
var {
...
__decorateClass([
  Validate61(FUNCTION14, { optional: true })
...
__decorateClass([
  Validate61(NUMBER13, { optional: true })
...
var { SectorBox: SectorBox3, motion: motion6 } = import_ag_charts_community162._Scene;
...
var { BandScale: BandScale4 } = import_ag_charts_community163._Scale;
var { Sector: Sector5, SectorBox: SectorBox4, motion: motion7 } = import_ag_charts_community163._Scene;
var { angleBetween: angleBetween4, isNumber: isNumber2, sanitizeHtml: sanitizeHtml10 } = import_ag_charts_community163._Util;
var RadialBarSeriesNodeEvent = class extends import_ag_charts_community163._ModuleSupport.SeriesNodeEvent {
  constructor(type, nativeEvent, datum, series) {
    super(type, nativeEvent, datum, series);
    this.angleKey = series.properties.angleKey;
    this.radiusKey = series.properties.radiusKey;
...
var RadialBarSeries = class extends import_ag_charts_community163._ModuleSupport.PolarSeries {
  constructor(moduleCtx) {
    super({
      moduleCtx,
      useLabelLayer: true,
...
var RADIAL_BAR_SERIES_THEME = {
  series: {
    ...
    label: {
      ...
      color: import_ag_charts_community164._Theme.DEFAULT_INVERTED_LABEL_COLOUR
    }
  },
  axes: {
    [import_ag_charts_community164._Theme.POLAR_AXIS_TYPE.RADIUS_CATEGORY]: {
...
var RadialBarModule = {
  ...
  defaultAxes: [
    {
      type: import_ag_charts_community165._Theme.POLAR_AXIS_TYPE.ANGLE_NUMBER
    },
    {
      type: import_ag_charts_community165._Theme.POLAR_AXIS_TYPE.RADIUS_CATEGORY
    }
  ],
...
var { Validate: Validate62, RATIO: RATIO27 } = import_ag_charts_community166._ModuleSupport;
var RadialColumnSeriesProperties = class extends RadialColumnSeriesBaseProperties {
};
__decorateClass([
  Validate62(RATIO27, { optional: true })
...
// packages/ag-charts-enterprise/src/series/radial-column/radialColumnSeries.ts
var { ChartAxisDirection: ChartAxisDirection19, PolarAxis: PolarAxis4 } = import_ag_charts_community167._ModuleSupport;
var { RadialColumnShape, getRadialColumnWidth } = import_ag_charts_community167._Scene;
...
var RADIAL_COLUMN_SERIES_THEME = {
  series: {
    ...
    label: {
      enabled: false,
      fontSize: 12,
      fontFamily: import_ag_charts_community168._Theme.DEFAULT_FONT_FAMILY,
      color: import_ag_charts_community168._Theme.DEFAULT_LABEL_COLOUR
    }
  },
  axes: {
    [import_ag_charts_community168._Theme.POLAR_AXIS_TYPE.ANGLE_CATEGORY]: {
      shape: import_ag_charts_community168._Theme.POLAR_AXIS_SHAPE.CIRCLE,
      groupPaddingInner: 0,
      paddingInner: 0,
      label: {
        padding: 10
    ...
    [import_ag_charts_community168._Theme.POLAR_AXIS_TYPE.RADIUS_NUMBER]: {
      shape: import_ag_charts_community168._Theme.POLAR_AXIS_SHAPE.CIRCLE,
...
var RadialColumnModule = {
  ...
  defaultAxes: [
    {
      type: import_ag_charts_community169._Theme.POLAR_AXIS_TYPE.ANGLE_CATEGORY
    },
    {
      type: import_ag_charts_community169._Theme.POLAR_AXIS_TYPE.RADIUS_NUMBER
    }
  ],
...
var { DropShadow, Label: Label9 } = import_ag_charts_community170._Scene;
var {
  ...
  RATIO: RATIO28,
  STRING: STRING29
} = import_ag_charts_community170._ModuleSupport;
var RangeAreaSeriesLabel = class extends Label9 {
  constructor() {
    super(...arguments);
...
__decorateClass([
  Validate63(PLACEMENT)
], RangeAreaSeriesLabel.prototype, "placement", 2);
__decorateClass([
  Validate63(POSITIVE_NUMBER24)
...
} = import_ag_charts_community171._ModuleSupport;
var { getMarker: getMarker3, PointerEvents: PointerEvents7 } = import_ag_charts_community171._Scene;
var { sanitizeHtml: sanitizeHtml11, extent: extent4 } = import_ag_charts_community171._Util;
var RangeAreaSeriesNodeEvent = class extends import_ag_charts_community171._ModuleSupport.SeriesNodeEvent {
  constructor(type, nativeEvent, datum, series) {
    super(type, nativeEvent, datum, series);
    this.xKey = series.properties.xKey;
...
var RangeAreaSeries = class extends import_ag_charts_community171._ModuleSupport.CartesianSeries {
  constructor(moduleCtx) {
    super({
      moduleCtx,
      hasMarkers: true,
  ...
  getTooltipHtml(nodeDatum) {
    ...
    if (!this.properties.isValid() || !xAxis || !yAxis) {
      return import_ag_charts_community171._ModuleSupport.EMPTY_TOOLTIP_CONTENT;
    }
    const { id: seriesId } = this;
  ...
  nodeFactory() {
    return new import_ag_charts_community171._Scene.Group();
  }
  ...
  computeFocusBounds(opts) {
    ...
    if (hiBox && loBox) {
      return import_ag_charts_community171._Scene.BBox.merge([hiBox, loBox]);
    }
    return void 0;
  }
};
...
var RANGE_AREA_SERIES_THEME = {
  series: {
    ...
    label: {
      ...
      padding: 10,
      fontSize: 12,
      fontFamily: import_ag_charts_community172._Theme.DEFAULT_FONT_FAMILY,
      color: import_ag_charts_community172._Theme.DEFAULT_LABEL_COLOUR
    },
    interpolation: {
      type: "linear",
  ...
  axes: {
    [import_ag_charts_community172._Theme.CARTESIAN_AXIS_TYPE.NUMBER]: {
...
// packages/ag-charts-enterprise/src/series/range-area/rangeAreaModule.ts
var { markerPaletteFactory: markerPaletteFactory2 } = import_ag_charts_community173._ModuleSupport;
var RangeAreaModule = {
  type: "series",
  optionsKey: "series[]",
  packageType: "enterprise",
  ...
  defaultAxes: [
    {
      type: import_ag_charts_community173._Theme.CARTESIAN_AXIS_TYPE.NUMBER,
      position: import_ag_charts_community173._Theme.POSITION.LEFT
    },
    {
      type: import_ag_charts_community173._Theme.CARTESIAN_AXIS_TYPE.CATEGORY,
      position: import_ag_charts_community173._Theme.POSITION.BOTTOM
    }
  ],
...
var { DropShadow: DropShadow2, Label: Label10 } = import_ag_charts_community174._Scene;
var {
...
var RangeBarSeriesLabel = class extends Label10 {
  constructor() {
    super(...arguments);
    this.placement = "inside";
    this.padding = 6;
...
__decorateClass([
  Validate64(PLACEMENT2)
], RangeBarSeriesLabel.prototype, "placement", 2);
__decorateClass([
  Validate64(POSITIVE_NUMBER25)
...
__decorateClass([
  Validate64(FUNCTION15, { optional: true })
...
var { Rect: Rect4, PointerEvents: PointerEvents8, motion: motion8 } = import_ag_charts_community175._Scene;
var { sanitizeHtml: sanitizeHtml12, isNumber: isNumber3, extent: extent5 } = import_ag_charts_community175._Util;
var { ContinuousScale: ContinuousScale3 } = import_ag_charts_community175._Scale;
var RangeBarSeriesNodeEvent = class extends import_ag_charts_community175._ModuleSupport.SeriesNodeEvent {
  constructor(type, nativeEvent, datum, series) {
    super(type, nativeEvent, datum, series);
    this.xKey = series.properties.xKey;
    this.yLowKey = series.properties.yLowKey;
...
var RangeBarSeries = class extends import_ag_charts_community175._ModuleSupport.AbstractBarSeries {
  constructor(moduleCtx) {
    super({
      moduleCtx,
      pickModes: [SeriesNodePickMode12.NEAREST_BY_MAIN_AXIS_FIRST, SeriesNodePickMode12.EXACT_SHAPE_MATCH],
      hasHighlightedLabels: true,
      directionKeys: {
        x: ["xKey"],
        y: ["yLowKey", "yHighKey"]
  ...
  async createNodeData() {
    ...
    processedData?.data.forEach(({ keys, datum, values }, dataIndex) => {
      values.forEach((value, valueIndex) => {
        ...
        if (!import_ag_charts_community175._Util.isNumber(rawHighValue) || !import_ag_charts_community175._Util.isNumber(rawLowValue)) {
          return;
        }
  ...
  getTooltipHtml(nodeDatum) {
    ...
    const yAxis = this.getValueAxis();
    if (!this.properties.isValid() || !xAxis || !yAxis) {
      return import_ag_charts_community175._ModuleSupport.EMPTY_TOOLTIP_CONTENT;
    }
    const {
      xKey,
      yLowKey,
...
var RANGE_BAR_SERIES_THEME = {
  series: {
    ...
    label: {
      enabled: false,
      fontSize: 12,
      fontFamily: import_ag_charts_community176._Theme.DEFAULT_FONT_FAMILY,
      color: import_ag_charts_community176._Theme.DEFAULT_INSIDE_SERIES_LABEL_COLOUR,
      placement: "inside"
    }
  },
  axes: {
    [import_ag_charts_community176._Theme.CARTESIAN_AXIS_TYPE.NUMBER]: {
      crosshair: { enabled: true }
    }
  }
};
...
var RangeBarModule = {
  ...
  defaultAxes: [
    {
      type: import_ag_charts_community177._Theme.CARTESIAN_AXIS_TYPE.CATEGORY,
      position: import_ag_charts_community177._Theme.POSITION.BOTTOM
    },
    {
      type: import_ag_charts_community177._Theme.CARTESIAN_AXIS_TYPE.NUMBER,
      position: import_ag_charts_community177._Theme.POSITION.LEFT
    }
  ],
...
var { BBox: BBox10, Path: Path9, ScenePathChangeDetection: ScenePathChangeDetection3, splitBezier } = import_ag_charts_community178._Scene;
...
var { Label: Label11 } = import_ag_charts_community179._Scene;
var ALIGNMENT = UNION7(["left", "right", "center", "justify"], "a justification value");
var SankeySeriesLabelProperties = class extends Label11 {
  constructor() {
    super(...arguments);
    this.spacing = 1;
  }
...
__decorateClass([
  Validate65(POSITIVE_NUMBER26)
], SankeySeriesLabelProperties.prototype, "spacing", 2);
var SankeySeriesLinkProperties = class extends BaseProperties20 {
  constructor() {
    super(...arguments);
    this.fill = void 0;
    this.fillOpacity = 1;
...
__decorateClass([
  Validate65(COLOR_STRING24, { optional: true })
...
__decorateClass([
  Validate65(ARRAY10, { optional: true })
...
__decorateClass([
  Validate65(STRING31, { optional: true })
...
__decorateClass([
  Validate65(COLOR_STRING_ARRAY6)
...
// packages/ag-charts-enterprise/src/series/sankey/sankeySeries.ts
var { SeriesNodePickMode: SeriesNodePickMode13, CachedTextMeasurerPool: CachedTextMeasurerPool9, TextWrapper: TextWrapper7, createDatumId: createDatumId9, EMPTY_TOOLTIP_CONTENT: EMPTY_TOOLTIP_CONTENT2 } = import_ag_charts_community180._ModuleSupport;
var { sanitizeHtml: sanitizeHtml13 } = import_ag_charts_community180._Util;
var { Rect: Rect5, Text: Text11, BBox: BBox11 } = import_ag_charts_community180._Scene;
  ...
  async createNodeData() {
    ...
    columns.forEach((column, index) => {
      ...
      column.nodes.forEach(({ datum: node }) => {
        ...
        let text;
        if (!leading && !trailing) {
          const y12 = y - fontSize * Text11.defaultLineHeightRatio;
          const y2 = y + fontSize * Text11.defaultLineHeightRatio;
          ...
          text = TextWrapper7.wrapText(node.label, {
            maxWidth,
        ...
        if (text === "")
          return;
        const { height } = CachedTextMeasurerPool9.measureText(text, {
          font: canvasFont,
          textAlign: "left",
          textBaseline: "middle"
        });
...
// packages/ag-charts-enterprise/src/series/sankey/sankeyModule.ts
var { DEFAULT_FONT_FAMILY: DEFAULT_FONT_FAMILY3, DEFAULT_LABEL_COLOUR: DEFAULT_LABEL_COLOUR4 } = import_ag_charts_community181._Theme;
var SankeyModule = {
  type: "series",
  optionsKey: "series[]",
  packageType: "enterprise",
...
var {
  ...
  RATIO: RATIO31,
  STRING: STRING32
} = import_ag_charts_community182._ModuleSupport;
...
// packages/ag-charts-enterprise/src/series/sunburst/sunburstSeries.ts
var { fromToMotion: fromToMotion3 } = import_ag_charts_community183._ModuleSupport;
var { Sector: Sector6, Group: Group15, Selection: Selection11, Text: Text12 } = import_ag_charts_community183._Scene;
var { sanitizeHtml: sanitizeHtml14 } = import_ag_charts_community183._Util;
...
var SunburstSeries = class extends import_ag_charts_community183._ModuleSupport.HierarchySeries {
  constructor() {
    super(...arguments);
  ...
  async updateSelections() {
    ...
    const updateGroup = (group) => {
      group.append([
        new Sector6(),
        new Text12({ tag: 0 /* Primary */ }),
        new Text12({ tag: 1 /* Secondary */ })
      ]);
    };
  ...
  async updateNodes() {
    ...
    const labelTextNode = new Text12();
    ...
    const labelMeta = Array.from(this.rootNode, (node, index) => {
      ...
      const sizeFittingHeight = (labelHeight2) => {
        ...
        } else if (import_ag_charts_community183._Util.normalizeAngle360(deltaInnerAngle) < maxPerpendicularAngle) {
    ...
    this.groupSelection.selectByClass(Text12).forEach((text) => {
      updateText(text.datum, text, text.tag, false);
    });
    this.highlightSelection.selectByClass(Text12).forEach((text) => {
  ...
  getTooltipHtml(node) {
    ...
    if (datum == null || depth == null) {
      return import_ag_charts_community183._ModuleSupport.EMPTY_TOOLTIP_CONTENT;
    }
  ...
  computeFocusBounds(nodeDatum) {
    ...
    for (const { node, datum } of this.groupSelection) {
      if (datum === nodeDatum) {
        match = import_ag_charts_community183._Scene.Selection.selectByClass(node, import_ag_charts_community183._Scene.Sector)[0];
      }
    }
    return match;
  }
...
// packages/ag-charts-enterprise/src/series/sunburst/sunburstModule.ts
var { DEFAULT_INSIDE_SERIES_LABEL_COLOUR } = import_ag_charts_community184._Theme;
var SunburstModule = {
  type: "series",
  optionsKey: "series[]",
  packageType: "enterprise",
  ...
  paletteFactory: ({ takeColors, colorsCount, themeTemplateParameters }) => {
    const { fills, strokes } = takeColors(colorsCount);
    const defaultColorRange = themeTemplateParameters.get(import_ag_charts_community184._Theme.DEFAULT_DIVERGING_SERIES_COLOUR_RANGE);
...
var { Label: Label12 } = import_ag_charts_community185._Scene;
var {
...
var TreemapGroupLabel = class extends Label12 {
  constructor() {
    super(...arguments);
    this.spacing = 0;
  }
...
var TreemapSeriesGroup = class extends BaseProperties21 {
  constructor() {
    super(...arguments);
    this.fillOpacity = 1;
    this.strokeWidth = 1;
...
__decorateClass([
  Validate67(POSITIVE_NUMBER28, { optional: true })
...
var TreemapSeriesGroupHighlightStyle = class extends BaseProperties21 {
  constructor() {
    super(...arguments);
    this.label = new AutoSizedLabel();
  }
...
__decorateClass([
  Validate67(RATIO32, { optional: true })
...
var TreemapSeriesTileHighlightStyle = class extends BaseProperties21 {
  constructor() {
    super(...arguments);
    this.label = new AutoSizedLabel();
    this.secondaryLabel = new AutoSizeableSecondaryLabel();
...
__decorateClass([
  Validate67(FUNCTION18, { optional: true })
...
// packages/ag-charts-enterprise/src/series/treemap/treemapSeries.ts
var { TextUtils: TextUtils5, TextWrapper: TextWrapper8 } = import_ag_charts_community186._ModuleSupport;
var { Rect: Rect6, Group: Group16, BBox: BBox12, Selection: Selection12, Text: Text13 } = import_ag_charts_community186._Scene;
var { Color: Color7, Logger: Logger17, clamp: clamp5, isEqual: isEqual2, sanitizeHtml: sanitizeHtml15 } = import_ag_charts_community186._Util;
var tempText = new Text13();
...
var DistantGroup = class extends import_ag_charts_community186._Scene.Group {
  distanceSquared(x, y) {
    return this.getBBox().distanceSquared(x, y);
  }
};
var TreemapSeries = class extends import_ag_charts_community186._ModuleSupport.HierarchySeries {
  constructor() {
    super(...arguments);
  ...
  squarify(node, bbox, outputBoxes, outputPadding) {
    ...
    const innerBox = new BBox12(bbox.x + padding.left, bbox.y + padding.top, width, height);
    ...
    while (i < numChildren) {
      ...
      for (let j = startIndex; j < i; j++) {
        ...
        const childBbox = new BBox12(x, y, stackWidth, stackHeight);
    ...
    for (let childIdx = startIndex; childIdx < numChildren; childIdx++) {
      ...
      const childBox = new BBox12(x, y, childWidth, childHeight);
  ...
  async updateSelections() {
    ...
    const updateGroup = (group) => {
      group.append([
        new Rect6(),
        new Text13({ tag: 0 /* Primary */ }),
        new Text13({ tag: 1 /* Secondary */ })
      ]);
    };
    this.groupSelection.update(descendants, updateGroup, (node) => this.getDatumId(node));
    this.highlightSelection.update(descendants, updateGroup, (node) => this.getDatumId(node));
  ...
  async updateNodes() {
    ...
    this.squarify(rootNode, new BBox12(0, 0, width, height), bboxes, paddings);
    ...
    const labelMeta = Array.from(this.rootNode, (node) => {
      ...
      if (children.length === 0) {
        ...
        const text = TextWrapper8.wrapText(labelDatum.label, {
    ...
    this.groupSelection.selectByClass(Text13).forEach((text) => {
      updateLabelFn(text.datum, text, text.tag, false);
    });
    this.highlightSelection.selectByClass(Text13).forEach((text) => {
  ...
  getTooltipHtml(node) {
    ...
    if (datum == null || depth == null || !interactive) {
      return import_ag_charts_community186._ModuleSupport.EMPTY_TOOLTIP_CONTENT;
    }
    const title = labelKey != null ? datum[labelKey] : void 0;
  ...
  pickFocus(opts) {
    ...
    if (depthDelta === 1) {
      ...
      current.childIndex = clamp5(0, targetIndex, maxIndex);
...
} = import_ag_charts_community187._Theme;
var TreemapModule = {
  type: "series",
  optionsKey: "series[]",
  packageType: "enterprise",
...
var { DropShadow: DropShadow3, Label: Label13 } = import_ag_charts_community188._Scene;
var {
...
__decorateClass([
  Validate68(UNION8(["subtotal", "total"], "a total type"))
...
__decorateClass([
  Validate68(FUNCTION19, { optional: true })
], WaterfallSeriesItemTooltip.prototype, "renderer", 2);
var WaterfallSeriesLabel = class extends Label13 {
  constructor() {
    super(...arguments);
    this.placement = "end";
    this.padding = 6;
...
__decorateClass([
  Validate68(UNION8(["start", "end", "inside"], "a placement"))
], WaterfallSeriesLabel.prototype, "placement", 2);
__decorateClass([
  Validate68(POSITIVE_NUMBER29)
...
__decorateClass([
  Validate68(STRING34, { optional: true })
], WaterfallSeriesItem.prototype, "name", 2);
__decorateClass([
  Validate68(COLOR_STRING27)
...
var { Rect: Rect7, motion: motion9 } = import_ag_charts_community189._Scene;
var { sanitizeHtml: sanitizeHtml16, isContinuous } = import_ag_charts_community189._Util;
var { ContinuousScale: ContinuousScale4 } = import_ag_charts_community189._Scale;
var WaterfallSeries = class extends import_ag_charts_community189._ModuleSupport.AbstractBarSeries {
  constructor(moduleCtx) {
    super({
      moduleCtx,
  ...
  async processData(dataController) {
    ...
    const { processedData } = await this.requestDataModel(dataController, dataWithTotals, {
      props: [
        ...
        ...isContinuousX ? [import_ag_charts_community189._ModuleSupport.SMALLEST_KEY_INTERVAL, import_ag_charts_community189._ModuleSupport.LARGEST_KEY_INTERVAL] : [],
        ...extraProps
      ]
    });
    this.smallestDataInterval = processedData.reduced?.smallestKeyInterval;
  ...
  getSeriesDomain(direction) {
    ...
    if (direction === this.getCategoryDirection()) {
      ...
      const keysExtent = import_ag_charts_community189._ModuleSupport.extent(keys) ?? [NaN, NaN];
      const categoryAxis = this.getCategoryAxis();
  ...
  getTooltipHtml(nodeDatum) {
    ...
    if (!this.properties.isValid() || !categoryAxis || !valueAxis) {
      return import_ag_charts_community189._ModuleSupport.EMPTY_TOOLTIP_CONTENT;
    }
    const { id: seriesId } = this;
  ...
  animateConnectorLinesHorizontal(lineNode, pointData) {
    ...
    this.ctx.animationManager.animate({
      ...
      from: startX,
      to: endX,
      ease: import_ag_charts_community189._ModuleSupport.Motion.easeOut,
      collapsable: false,
      onUpdate(pointX) {
        linePath.clear(true);
  ...
  updateLineNode(lineNode) {
    ...
    lineNode.setProperties({
      ...
      lineDashOffset,
      lineJoin: "round",
      pointerEvents: import_ag_charts_community189._Scene.PointerEvents.None
    });
  }
  isLabelEnabled() {
...
var itemTheme = {
  ...
  label: {
    enabled: false,
    fontStyle: void 0,
    fontWeight: import_ag_charts_community190._Theme.FONT_WEIGHT.NORMAL,
    fontSize: 12,
    fontFamily: import_ag_charts_community190._Theme.DEFAULT_FONT_FAMILY,
    color: import_ag_charts_community190._Theme.DEFAULT_LABEL_COLOUR,
    formatter: void 0,
    placement: "end"
  }
};
var WATERFALL_SERIES_THEME = {
  series: {
    ...
    line: {
      stroke: import_ag_charts_community190._Theme.PALETTE_NEUTRAL_STROKE,
      strokeOpacity: 1,
      lineDash: [0],
      lineDashOffset: 0,
      strokeWidth: 2
...
var WaterfallModule = {
  ...
  defaultAxes: [
    {
      type: import_ag_charts_community191._Theme.CARTESIAN_AXIS_TYPE.CATEGORY,
      position: import_ag_charts_community191._Theme.POSITION.BOTTOM
    },
    {
      type: import_ag_charts_community191._Theme.CARTESIAN_AXIS_TYPE.NUMBER,
      position: import_ag_charts_community191._Theme.POSITION.LEFT
    }
  ],
    ...
    return {
      ...
      item: {
        positive: {
          ...
          label: {
            color: import_ag_charts_community191._Theme.DEFAULT_LABEL_COLOUR
          }
        },
        negative: {
...
function setupEnterpriseModules() {
  import_ag_charts_community192._ModuleSupport.moduleRegistry.register(
  ...
  import_ag_charts_community192._ModuleSupport.enterpriseModule.isEnterprise = true;
  import_ag_charts_community192._ModuleSupport.enterpriseModule.styles = styles_default;
  import_ag_charts_community192._ModuleSupport.enterpriseModule.licenseManager = (options) => new LicenseManager(
    options.container?.ownerDocument ?? (typeof document === "undefined" ? void 0 : document)
  );
  import_ag_charts_community192._ModuleSupport.enterpriseModule.injectWatermark = injectWatermark;
}
