...
var { ChartAxisDirection: ChartAxisDirection6 } = _ModuleSupport13;
...
// packages/ag-charts-enterprise/src/features/color-picker/colorPicker.ts
var { clamp, createElement } = _ModuleSupport14;
var { Color } = _Util10;
...
var ColorPicker = class extends _ModuleSupport14.BaseModuleInstance {
  constructor(ctx) {
    super();
    this.ctx = ctx;
...
var { createElement: createElement2 } = _ModuleSupport15;
var canvasOverlay2 = "canvas-overlay";
var Popover = class extends _ModuleSupport15.BaseModuleInstance {
  constructor(ctx, id) {
    super();
    this.ctx = ctx;
    this.anchor = void 0;
...
import { _ModuleSupport as _ModuleSupport16, _Scene as _Scene9 } from "ag-charts-community";
...
// packages/ag-charts-enterprise/src/features/text-input/textInput.ts
var { getDocument, getWindow } = _ModuleSupport16;
var moduleId2 = "text-input";
var canvasOverlay3 = "canvas-overlay";
var TextInput = class extends _ModuleSupport16.BaseModuleInstance {
  constructor(ctx) {
    super();
    this.ctx = ctx;
    this.layout = {
  ...
  getBBox() {
    ...
    return new _Scene9.BBox(left, top, width, height);
  }
};
...
import { _Util as _Util14 } from "ag-charts-community";
var { Logger } = _Util14;
...
import { _ModuleSupport as _ModuleSupport21, _Util as _Util16 } from "ag-charts-community";

// packages/ag-charts-enterprise/src/features/annotations/annotationProperties.ts
import {
  _ModuleSupport as _ModuleSupport19,
  _Util as _Util15
} from "ag-charts-community";
var {
  BOOLEAN: BOOLEAN4,
...
import { _ModuleSupport as _ModuleSupport22, _Scene as _Scene14 } from "ag-charts-community";
...
var _Handle = class _Handle extends _Scene13.Group {
  constructor() {
    super(...arguments);
    this.active = false;
    this.locked = false;
...
var _InvariantHandle = class _InvariantHandle extends Handle2 {
  constructor() {
    super();
    this.handle = new _Scene13.Circle();
    this.glow = new _Scene13.Circle();
...
var _UnivariantHandle = class _UnivariantHandle extends Handle2 {
  constructor() {
    super();
    this.handle = new _Scene13.Rect();
    this.glow = new _Scene13.Rect();
...
// packages/ag-charts-enterprise/src/features/annotations/scenes/annotationScene.ts
var { Layers: Layers3, isObject: isObject2 } = _ModuleSupport22;
var AnnotationScene = class extends _Scene14.Group {
  constructor() {
    super(...arguments);
  ...
  getCachedBBoxWithoutHandles() {
    return this.cachedBBoxWithoutHandles ?? _Scene14.BBox.zero;
  }
  computeBBoxWithoutHandles() {
    this.computeTransformMatrix();
    return _Scene14.Group.computeBBox(this.children.filter((node) => !(node instanceof Handle2)));
  }
  render(renderCtx) {
...
import { _ModuleSupport as _ModuleSupport23, _Scene as _Scene15, _Util as _Util18 } from "ag-charts-community";

// packages/ag-charts-enterprise/src/features/annotations/scenes/linearScene.ts
import { _Util as _Util17 } from "ag-charts-community";
var { Vec2 } = _Util17;
...
// packages/ag-charts-enterprise/src/features/annotations/scenes/textualStartEndScene.ts
var { CachedTextMeasurerPool, TextWrapper: TextWrapper2 } = _ModuleSupport23;
var { BBox } = _Scene15;
var { Vec2: Vec22 } = _Util18;
var _TextualStartEndScene = class _TextualStartEndScene extends LinearScene {
  constructor() {
    super(...arguments);
    this.label = new _Scene15.Text({ zIndex: 1 });
  ...
  setTextInputBBox(bbox) {
    ...
    this.markDirty(this, _Scene15.RedrawType.MINOR);
  }
...
// packages/ag-charts-enterprise/src/features/annotations/callout/calloutScene.ts
var { drawCorner } = _Scene16;
var CalloutScene = class extends TextualStartEndScene {
  constructor() {
    super();
    this.type = "callout" /* Callout */;
    this.shape = new _Scene16.Path();
...
import { _ModuleSupport as _ModuleSupport25, _Util as _Util20 } from "ag-charts-community";
...
var { STRING: STRING5, BaseProperties: BaseProperties4, Validate: Validate14 } = _ModuleSupport24;
...
// packages/ag-charts-enterprise/src/features/annotations/comment/commentProperties.ts
var { STRING: STRING6, Validate: Validate15, isObject: isObject3 } = _ModuleSupport25;
var { Color: Color3 } = _Util20;
...
import { _Scene as _Scene19 } from "ag-charts-community";

// packages/ag-charts-enterprise/src/features/annotations/scenes/textualPointScene.ts
import { _ModuleSupport as _ModuleSupport26, _Scene as _Scene18, _Util as _Util21 } from "ag-charts-community";
var { CachedTextMeasurerPool: CachedTextMeasurerPool2, TextWrapper: TextWrapper3 } = _ModuleSupport26;
var { Vec2: Vec23 } = _Util21;
var _TextualPointScene = class _TextualPointScene extends AnnotationScene {
  constructor() {
    super(...arguments);
    this.label = new _Scene18.Text({ zIndex: 1 });
  ...
  setTextInputBBox(bbox) {
    this.textInputBBox = bbox;
    this.markDirty(this, _Scene18.RedrawType.MINOR);
  }
  update(datum, context) {
  ...
  getTextBBox(datum, coords, _context) {
    const { textInputBBox } = this;
    if (textInputBBox) {
      return new _Scene18.BBox(coords.x, coords.y, textInputBBox.width, textInputBBox.height);
    }
    const text = this.wrapText(datum, datum.width);
    const textOptions = this.getTextOptions(datum);
    ...
    return new _Scene18.BBox(coords.x, coords.y, width, height);
  }
...
// packages/ag-charts-enterprise/src/features/annotations/comment/commentScene.ts
var { drawCorner: drawCorner2 } = _Scene19;
var CommentScene = class _CommentScene extends TextualPointScene {
  constructor() {
    super();
    this.type = "comment" /* Comment */;
    this.shape = new _Scene19.Path();
...
var { STRING: STRING7, BaseProperties: BaseProperties5, Validate: Validate16, isObject: isObject4 } = _ModuleSupport27;
...
import { _ModuleSupport as _ModuleSupport29, _Util as _Util24 } from "ag-charts-community";

// packages/ag-charts-enterprise/src/features/annotations/scenes/axisLabelScene.ts
import { _ModuleSupport as _ModuleSupport28, _Scene as _Scene20 } from "ag-charts-community";
var { calculateLabelTranslation, ChartAxisDirection: ChartAxisDirection7 } = _ModuleSupport28;
var AxisLabelScene = class extends _Scene20.Group {
  constructor() {
    super({ name: "AnnotationAxisLabelGroup" });
    this.label = new _Scene20.Text({ zIndex: 1 });
    this.rect = new _Scene20.Rect();
    const { label } = this;
    label.fontSize = 12;
...
import { _Scene as _Scene21, _Util as _Util23 } from "ag-charts-community";
var { Vec2: Vec24 } = _Util23;
var CollidableLine = class extends _Scene21.Line {
  constructor() {
    super(...arguments);
  ...
  updateCollisionBBox() {
    ...
    this.collisionBBox = new _Scene21.BBox(topLeft.x, topLeft.y, width, height);
  }
...
// packages/ag-charts-enterprise/src/features/annotations/cross-line/crossLineScene.ts
var { Vec2: Vec25 } = _Util24;
var { ChartAxisDirection: ChartAxisDirection8 } = _ModuleSupport29;
...
import { _ModuleSupport as _ModuleSupport30, _Util as _Util25 } from "ag-charts-community";
var { NUMBER: NUMBER4, STRING: STRING8, BaseProperties: BaseProperties6, Validate: Validate17, isObject: isObject5 } = _ModuleSupport30;
var DisjointChannelProperties = class extends Annotation(Background(Line(Handle(Stroke(LineDash(BaseProperties6)))))) {
  ...
  get bottom() {
    ...
    if (typeof bottom.start.y === "number" && typeof bottom.end.y === "number") {
      ...
      _Util25.Logger.warnOnce(`Annotation [${this.type}] can only be used with a numeric y-axis.`);
    }
    return bottom;
  }
  isValidWithContext(context, warningPrefix) {
...
import { _Util as _Util26 } from "ag-charts-community";
...
var { STRING: STRING9, BaseProperties: BaseProperties7, Validate: Validate18, isObject: isObject6 } = _ModuleSupport31;
...
import { _ModuleSupport as _ModuleSupport33, _Util as _Util28 } from "ag-charts-community";

// packages/ag-charts-enterprise/src/features/annotations/note/noteScene.ts
import { _ModuleSupport as _ModuleSupport32, _Scene as _Scene24, _Util as _Util27 } from "ag-charts-community";
var ICON_HEIGHT = 20;
var ICON_WIDTH = 22;
var ICON_SPACING = 10;
var LABEL_OFFSET = ICON_HEIGHT + ICON_SPACING;
var { Layers: Layers4, TextWrapper: TextWrapper4 } = _ModuleSupport32;
var { clamp: clamp2 } = _Util27;
var NoteScene = class extends TextualPointScene {
  constructor() {
    super();
    this.type = "note" /* Note */;
    this.shape = new _Scene24.Rect();
    this.iconBackground = new _Scene24.SvgPath(
    ...
    this.iconLines = new _Scene24.SvgPath(
    ...
    this.iconBackground.fillShadow = new _Scene24.DropShadow();
...
// packages/ag-charts-enterprise/src/features/annotations/note/noteProperties.ts
var { OBJECT: OBJECT5, STRING: STRING10, BaseProperties: BaseProperties8, Validate: Validate19, isObject: isObject7 } = _ModuleSupport33;
var { clamp: clamp3 } = _Util28;
...
import { _ModuleSupport as _ModuleSupport34, _Util as _Util29 } from "ag-charts-community";
var { NUMBER: NUMBER5, STRING: STRING11, OBJECT: OBJECT6, BaseProperties: BaseProperties9, Validate: Validate20, isObject: isObject8 } = _ModuleSupport34;
var ParallelChannelProperties = class extends Annotation(
  ...
  get bottom() {
    ...
    if (typeof bottom.start.y === "number" && typeof bottom.end.y === "number") {
      ...
      _Util29.Logger.warnOnce(`Annotation [${this.type}] can only be used with a numeric y-axis.`);
    }
    return bottom;
  }
  isValidWithContext(context, warningPrefix) {
...
import { _Scene as _Scene26, _Util as _Util30 } from "ag-charts-community";
var { Vec2: Vec27 } = _Util30;
var ParallelChannelScene = class extends ChannelScene {
  constructor() {
    ...
    this.middleLine = new _Scene26.Line();
...
import { _ModuleSupport as _ModuleSupport47, _Util as _Util42 } from "ag-charts-community";
...
import { _ModuleSupport as _ModuleSupport37, _Util as _Util32 } from "ag-charts-community";
...
// packages/ag-charts-enterprise/src/features/annotations/states/textualStartEndState.ts
var { StateMachine } = _ModuleSupport37;
...
import { _ModuleSupport as _ModuleSupport39, _Util as _Util34 } from "ag-charts-community";
var { StateMachine: StateMachine2 } = _ModuleSupport39;
var TextualPointStateMachine = class extends StateMachine2 {
  constructor(ctx) {
    ...
    this.debug = _Util34.Debug.create(true, "annotations");
  }
};
...
import { _ModuleSupport as _ModuleSupport41, _Util as _Util36 } from "ag-charts-community";
var { StateMachine: StateMachine3 } = _ModuleSupport41;
...
import { _ModuleSupport as _ModuleSupport42, _Util as _Util37 } from "ag-charts-community";
var { StateMachine: StateMachine4 } = _ModuleSupport42;
var DisjointChannelStateMachine = class extends StateMachine4 {
  constructor(ctx) {
    ...
    this.debug = _Util37.Debug.create(true, "annotations");
  }
};

// packages/ag-charts-enterprise/src/features/annotations/line/lineState.ts
import { _ModuleSupport as _ModuleSupport43, _Util as _Util38 } from "ag-charts-community";
var { StateMachine: StateMachine5 } = _ModuleSupport43;
var LineStateMachine = class extends StateMachine5 {
  constructor(ctx) {
    ...
    this.debug = _Util38.Debug.create(true, "annotations");
  }
};
...
import { _ModuleSupport as _ModuleSupport45, _Util as _Util40 } from "ag-charts-community";
var { StateMachine: StateMachine6 } = _ModuleSupport45;
var ParallelChannelStateMachine = class extends StateMachine6 {
  constructor(ctx) {
    ...
    this.debug = _Util40.Debug.create(true, "annotations");
  }
};
...
// packages/ag-charts-enterprise/src/features/annotations/annotationsStateMachine.ts
var { StateMachine: StateMachine7 } = _ModuleSupport47;
...
var { BaseModuleInstance, InteractionState, Validate: Validate22, BOOLEAN: BOOLEAN5, createElement: createElement3, REGIONS, ChartAxisDirection: ChartAxisDirection9 } = _ModuleSupport48;
...
var AxisButton = class extends BaseModuleInstance {
  ...
  updateButtonElement() {
    ...
    button.onclick = _ModuleSupport48.makeAccessibleClickListener(button, () => this.onButtonClick(this.coords));
...
var Annotations = class extends _ModuleSupport49.BaseModuleInstance {
  constructor(ctx) {
    super();
    this.ctx = ctx;
    ...
    this.container = new _Scene33.Group({ name: "static-annotations" });
    this.annotations = new _Scene33.Selection(
      this.container,
  ...
  onToolbarButtonPressAnnotation(event) {
    ...
    if (annotation) {
      ...
      _Util43.Logger.errorOnce(`Can not create unknown annotation type [${event.value}], ignoring.`);
      this.update();
    }
  }
  ...
  updateToolbarColorPickerFill(colorPickerType, color, opacity) {
    if (color != null && opacity != null) {
      const { r, g, b } = _Util43.Color.fromString(color);
      color = _Util43.Color.fromArray([r, g, b, opacity]).toHexString();
    }
  ...
  onLayoutComplete(event) {
    ...
    for (const axisLayout of event.axes ?? []) {
      if (axisLayout.direction === _ModuleSupport49.ChartAxisDirection.X) {
  ...
  getAxis(axisLayout, seriesRect, button) {
    ...
    const bounds = buildBounds(new _Scene33.BBox(0, 0, seriesRect.width, seriesRect.height), axisPosition, padding);
...
__decorateClass([
  _ModuleSupport49.ObserveChanges((target, enabled) => {
    const {
...
import { _ModuleSupport as _ModuleSupport50, _Scene as _Scene34 } from "ag-charts-community";
var {
...
var Image = class extends BaseProperties10 {
  constructor() {
    ...
    this.node = new _Scene34.Image(this.imageElement);
  }
  get complete() {
...
// packages/ag-charts-enterprise/src/features/background/background.ts
var { ActionOnSet, OBJECT: OBJECT7, Validate: Validate25 } = _ModuleSupport51;
var Background2 = class extends _ModuleSupport51.Background {
  constructor(ctx) {
    super(ctx);
    this.ctx = ctx;
  ...
  onImageLoad() {
    this.ctx.updateService.update(_ModuleSupport51.ChartUpdateType.SCENE_RENDER);
  }
};
__decorateClass([
...
var ChartToolbar = class extends _ModuleSupport52.BaseModuleInstance {
  constructor(ctx) {
    super();
    this.ctx = ctx;
    this.enabled = false;
...
__decorateClass([
  _ModuleSupport52.Validate(_ModuleSupport52.BOOLEAN),
  _ModuleSupport52.ActionOnSet({
...
import { _ModuleSupport as _ModuleSupport53, _Util as _Util44 } from "ag-charts-community";
...
// packages/ag-charts-enterprise/src/features/context-menu/contextMenu.ts
var { BOOLEAN: BOOLEAN7, Validate: Validate26, createElement: createElement5, initMenuKeyNav, makeAccessibleClickListener, ContextMenuRegistry } = _ModuleSupport53;
var { Logger: Logger2 } = _Util44;
...
var ContextMenu = class extends _ModuleSupport53.BaseModuleInstance {
  constructor(ctx) {
    super();
    this.ctx = ctx;
    this.enabled = true;
    ...
    const { All } = _ModuleSupport53.InteractionState;
  ...
  show() {
    this.interactionManager.pushState(_ModuleSupport53.InteractionState.ContextMenu);
  ...
  hide() {
    this.interactionManager.popState(_ModuleSupport53.InteractionState.ContextMenu);
    if (this.menuElement) {
    ...
    if (ContextMenuRegistry.checkCallback("legend", type, callback)) {
      ...
      return () => {
        ...
        if (event) {
          ...
          _Util44.Logger.error("series node not found");
        }
        this.hide();
      };
    }
  ...
  reposition() {
    ...
    x = _ModuleSupport53.clamp(0, x, canvasRect.width - width);
    y = _ModuleSupport53.clamp(0, y, canvasRect.height - height);
...
import { _ModuleSupport as _ModuleSupport55, _Scene as _Scene37, _Util as _Util46 } from "ag-charts-community";

// packages/ag-charts-enterprise/src/features/crosshair/crosshairLabel.ts
import { _ModuleSupport as _ModuleSupport54, _Scene as _Scene36, _Util as _Util45 } from "ag-charts-community";
var { ActionOnSet: ActionOnSet2, BaseProperties: BaseProperties11, BOOLEAN: BOOLEAN8, FUNCTION: FUNCTION2, NUMBER: NUMBER7, STRING: STRING13, Validate: Validate27 } = _ModuleSupport54;
var { setAttribute } = _Util45;
var DEFAULT_LABEL_CLASS = "ag-crosshair-label";
var CrosshairLabelProperties = class extends _Scene36.ChangeDetectableProperties {
  constructor() {
    super(...arguments);
    this.enabled = true;
    this.xOffset = 0;
...
var CrosshairLabel = class extends BaseProperties11 {
  ...
  getBBox() {
    const { element } = this;
    return new _Scene36.BBox(element.clientLeft, element.clientTop, element.clientWidth, element.clientHeight);
  }
  toggle(visible) {
...
// packages/ag-charts-enterprise/src/features/crosshair/crosshair.ts
var { Group: Group3, Line: Line2, BBox: BBox2 } = _Scene37;
var { createId: createId2 } = _Util46;
var { POSITIVE_NUMBER: POSITIVE_NUMBER6, RATIO: RATIO6, BOOLEAN: BOOLEAN9, COLOR_STRING: COLOR_STRING3, LINE_DASH: LINE_DASH3, OBJECT: OBJECT8, InteractionState: InteractionState3, Validate: Validate28, Layers: Layers5 } = _ModuleSupport55;
var Crosshair = class extends _ModuleSupport55.BaseModuleInstance {
  constructor(ctx) {
    super();
    this.ctx = ctx;
    ...
    this.lineGroupSelection = _Scene37.Selection.select(this.lineGroup, Line2, false);
  ...
  onMouseMove(event) {
    ...
    this.ctx.updateService.update(_ModuleSupport55.ChartUpdateType.SCENE_RENDER);
  }
  onMouseOut() {
    this.hideCrosshairs();
  }
...
var { BOOLEAN: BOOLEAN10, FUNCTION: FUNCTION3, ActionOnSet: ActionOnSet3, Validate: Validate29 } = _ModuleSupport56;
var DataSource = class extends _ModuleSupport56.BaseModuleInstance {
  constructor(ctx) {
    super();
    this.enabled = false;
...
import { AgErrorBarSupportedSeriesTypes, _ModuleSupport as _ModuleSupport59, _Scene as _Scene39, _Util as _Util47 } from "ag-charts-community";

// packages/ag-charts-enterprise/src/features/error-bar/errorBarNode.ts
import { _ModuleSupport as _ModuleSupport57, _Scene as _Scene38 } from "ag-charts-community";
var { nearestSquaredInContainer, partialAssign, mergeDefaults } = _ModuleSupport57;
var { BBox: BBox3 } = _Scene38;
...
var ErrorBarNode = class extends _Scene38.Group {
  constructor() {
    super();
    this.capLength = NaN;
    this._datum = void 0;
    this.whiskerPath = new _Scene38.Path();
    this.capsPath = new _Scene38.Path();
...
var ErrorBarGroup = class extends _Scene38.Group {
  get children() {
...
import {
  _ModuleSupport as _ModuleSupport58
} from "ag-charts-community";
var {
...
var ErrorBars = class _ErrorBars extends _ModuleSupport59.BaseModuleInstance {
  constructor(ctx) {
    super();
    ...
    this.groupNode = new ErrorBarGroup({
      ...
      zIndex: _ModuleSupport59.Layers.SERIES_LAYER_ZINDEX,
      zIndexSubOrder: series.getGroupZIndexSubOrder("annotation")
    });
    annotationGroup.appendChild(this.groupNode);
    this.selection = _Scene39.Selection.select(this.groupNode, () => this.errorBarFactory());
  ...
  static getDatumKey(datum, key, offset) {
    ...
    if (typeof value !== "number") {
      _Util47.Logger.warnOnce(`Found [${key}] error value of type ${typeof value}. Expected number type`);
      return;
    }
    return value + offset;
  }
...
var { Layers: Layers6, ActionOnSet: ActionOnSet4, Validate: Validate31, ProxyPropertyOnWrite: ProxyPropertyOnWrite2, OBJECT: OBJECT10, RATIO: RATIO8, COLOR_STRING: COLOR_STRING5 } = _ModuleSupport60;
var Foreground = class extends _ModuleSupport60.Background {
  constructor(ctx) {
  ...
  onImageLoad() {
    this.ctx.updateService.update(_ModuleSupport60.ChartUpdateType.SCENE_RENDER);
  }
...
import { _ModuleSupport as _ModuleSupport63, _Theme as _Theme6 } from "ag-charts-community";
...
import { _ModuleSupport as _ModuleSupport61, _Scene as _Scene40, _Util as _Util48 } from "ag-charts-community";
var { Validate: Validate32, BOOLEAN: BOOLEAN12, POSITIVE_NUMBER: POSITIVE_NUMBER8, Layers: Layers7, ActionOnSet: ActionOnSet5, CategoryAxis, GroupedCategoryAxis, TextUtils: TextUtils2 } = _ModuleSupport61;
var { Padding, Logger: Logger3 } = _Util48;
var { Group: Group4, BBox: BBox4 } = _Scene40;
...
var MiniChart = class extends _ModuleSupport61.BaseModuleInstance {
  constructor(ctx) {
    super();
    this.ctx = ctx;
    this.enabled = false;
...
// packages/ag-charts-enterprise/src/features/navigator/navigator.ts
var { ObserveChanges: ObserveChanges3 } = _ModuleSupport62;
var Navigator = class extends _ModuleSupport62.Navigator {
  constructor(ctx) {
    super(ctx);
...
var NavigatorModule = {
  ...
  themeTemplate: {
    ..._ModuleSupport63.NavigatorModule.themeTemplate,
    navigator: {
      ..._ModuleSupport63.NavigatorModule.themeTemplate?.navigator,
      miniChart: {
        enabled: false,
        label: {
...
import { _ModuleSupport as _ModuleSupport64, _Scene as _Scene42 } from "ag-charts-community";
var { CachedTextMeasurerPool: CachedTextMeasurerPool3, Validate: Validate33, OBJECT: OBJECT11, BOOLEAN: BOOLEAN13, STRING: STRING15, valueProperty: valueProperty2 } = _ModuleSupport64;
var { Label: Label2, Text: Text4, Group: Group5 } = _Scene42;
...
var StatusBar = class extends _ModuleSupport64.BaseModuleInstance {
  constructor(ctx) {
    super();
    this.ctx = ctx;
    this.enabled = false;
...
import { _ModuleSupport as _ModuleSupport66, _Util as _Util49 } from "ag-charts-community";
var {
  BOOLEAN: BOOLEAN14,
  STRING: STRING16,
  UNION: UNION5,
...
import { _ModuleSupport as _ModuleSupport76, _Util as _Util52 } from "ag-charts-community";

// packages/ag-charts-enterprise/src/features/zoom/scenes/zoomRect.ts
import { _ModuleSupport as _ModuleSupport67, _Scene as _Scene43 } from "ag-charts-community";
var { COLOR_STRING: COLOR_STRING6, RATIO: RATIO9, Validate: Validate35 } = _ModuleSupport67;
var ZoomRect = class extends _Scene43.Rect {
  constructor() {
    super(...arguments);
...
var { clamp: clamp4, isEqual, round } = _ModuleSupport68;
...
var ZoomAxisDragger = class {
  update(event, direction, anchor, bbox, zoom, axisZoom) {
    this.oldZoom ?? (this.oldZoom = definedZoomState(
      direction === _ModuleSupport69.ChartAxisDirection.X ? { ...zoom, x: axisZoom } : { ...zoom, y: axisZoom }
    ));
  ...
  updateZoom(direction, anchor, bbox) {
    ...
    if (!coords || !oldZoom) {
      if (direction === _ModuleSupport69.ChartAxisDirection.X)
        return newZoom.x;
      return newZoom.y;
    }
...
var ZoomPanner = class {
  ...
  translateZooms(bbox, currentZooms, deltaX, deltaY) {
    ...
    for (const [axisId, { direction, zoom: currentZoom }] of Object.entries(currentZooms)) {
      let zoom;
      if (direction === _ModuleSupport70.ChartAxisDirection.X) {
...
var { AND: AND5, DATE: DATE2, NUMBER: NUMBER9, OR: OR3, ActionOnSet: ActionOnSet6, isFiniteNumber: isFiniteNumber2, isValidDate, Validate: Validate36, arraysEqual: arraysEqual2 } = _ModuleSupport71;
var ZoomRange = class {
...
var { AND: AND6, GREATER_THAN: GREATER_THAN4, LESS_THAN: LESS_THAN3, RATIO: RATIO10, ActionOnSet: ActionOnSet7, Validate: Validate37 } = _ModuleSupport72;
var ZoomRatio = class {
  constructor(onChange) {
    this.onChange = onChange;
  }
...
var ZoomScrollPanner = class {
  ...
  translateZooms(bbox, currentZooms, deltaX) {
    ...
    for (const [axisId, { direction, zoom: currentZoom }] of Object.entries(currentZooms)) {
      if (direction !== _ModuleSupport73.ChartAxisDirection.X)
        continue;
...
var ZoomScroller = class {
  updateAxes(event, props, bbox, zooms) {
    ...
    for (const [axisId, { direction, zoom }] of Object.entries(zooms)) {
      ...
      if (direction === _ModuleSupport74.ChartAxisDirection.X && isScalingX) {
        newZoom.max += delta3;
        newZoom = scaleZoomAxisWithAnchor(newZoom, zoom, anchorPointX, origin.x);
      } else if (direction === _ModuleSupport74.ChartAxisDirection.Y && isScalingY) {
        newZoom.max += delta3;
...
var { ChartAxisDirection: ChartAxisDirection12, ToolbarManager: ToolbarManager2 } = _ModuleSupport75;
...
var ZoomButtonsProperties = class extends _ModuleSupport76.BaseProperties {
  constructor(onChange) {
    super();
    this.onChange = onChange;
    this.enabled = false;
...
__decorateClass([
  _ModuleSupport76.ObserveChanges((target) => {
    target.onChange();
  }),
...
var Zoom = class extends _ModuleSupport76.BaseModuleInstance {
  constructor(ctx) {
    super();
    this.ctx = ctx;
    this.enabled = false;
    ...
    const { Default: Default4, ZoomDrag, Animation: Animation2 } = _ModuleSupport76.InteractionState;
  ...
  onDrag(event) {
    ...
    if (!enabled || !paddedRect || !seriesRect)
      return;
    interactionManager.pushState(_ModuleSupport76.InteractionState.ZoomDrag);
    const zoom = this.getZoom();
    switch (dragState) {
      case 1 /* Axis */:
        if (!hoveredAxis)
        ...
        const anchor = direction === _ModuleSupport76.ChartAxisDirection.X ? anchorPointX : anchorPointY;
  ...
  onDragEnd(_event) {
    ...
    interactionManager.popState(_ModuleSupport76.InteractionState.ZoomDrag);
  ...
  onWheelScrolling(event) {
    ...
    if (isAxisScrolling) {
      isScalingX = hoveredAxis.direction === _ModuleSupport76.ChartAxisDirection.X;
  ...
  onLayoutComplete(event) {
    ...
    if (!axes)
      return;
    const [axesX, axesY] = _Util52.bifurcate((axis) => axis.direction === ChartAxisDirection13.X, axes);
...
var { BOOLEAN: BOOLEAN16, OBJECT: OBJECT12, POSITION, POSITIVE_NUMBER: POSITIVE_NUMBER9, BaseProperties: BaseProperties14, AxisTicks, Layers: Layers8, ProxyProperty: ProxyProperty3, Validate: Validate39 } = _ModuleSupport77;
var { Group: Group6, Rect, LinearGradientFill, Triangle } = _Scene46;
var { createId: createId3 } = _Util53;
...
var { createElement: createElement6 } = _ModuleSupport78;
...
import { _Theme as _Theme10, _Util as _Util56 } from "ag-charts-community";

// packages/ag-charts-enterprise/src/series/box-plot/boxPlotSeries.ts
import { _ModuleSupport as _ModuleSupport81, _Scale as _Scale8, _Scene as _Scene48, _Util as _Util55 } from "ag-charts-community";
...
import { _ModuleSupport as _ModuleSupport79, _Scene as _Scene47, _Util as _Util54 } from "ag-charts-community";
var { Group: Group7, Rect: Rect2, Line: Line3, BBox: BBox5, Selection: Selection2 } = _Scene47;
var { Logger: Logger5 } = _Util54;
var BoxPlotGroup = class extends Group7 {
  ...
  distanceSquared(x, y) {
    ...
    return _ModuleSupport79.nearestSquared(x, y, nodes).distanceSquared;
  }
  get midPoint() {
...
var { motion } = _Scene48;
var { ContinuousScale } = _Scale8;
var { Color: Color4 } = _Util55;
var BoxPlotSeriesNodeEvent = class extends _ModuleSupport81.SeriesNodeEvent {
...
var BoxPlotSeries = class extends _ModuleSupport81.AbstractBarSeries {
  constructor(moduleCtx) {
    super({
      moduleCtx,
  ...
  getTooltipHtml(nodeDatum) {
    ...
    if (!xAxis || !yAxis || !this.properties.isValid())
      return _ModuleSupport81.EMPTY_TOOLTIP_CONTENT;
    const title = _Util55.sanitizeHtml(yName);
    const contentData = [
      [xKey, xName, xAxis],
    ...
    const content = contentData.map(([key, name, axis]) => _Util55.sanitizeHtml(`${name ?? key}: ${axis.formatDatum(datum[key])}`)).join(title ? "<br/>" : ", ");
...
import { _ModuleSupport as _ModuleSupport83, _Scene as _Scene49, _Util as _Util57 } from "ag-charts-community";
...
var { fromToMotion } = _Scene49.motion;
var { sanitizeHtml, Color: Color6 } = _Util57;
var STYLING_KEYS = [
  "fill",
  "fillOpacity",
  "stroke",
...
var BulletSeries = class extends _ModuleSupport83.AbstractBarSeries {
  constructor(moduleCtx) {
    super({
      moduleCtx,
      ...
      pickModes: [
        _ModuleSupport83.SeriesNodePickMode.NEAREST_NODE,
        _ModuleSupport83.SeriesNodePickMode.EXACT_SHAPE_MATCH
      ],
      hasHighlightedLabels: true,
      animationResetFns: {
    ...
    this.colorRangesGroup = new _Scene49.Group({ name: `${this.id}-colorRanges` });
    this.colorRangesSelection = _Scene49.Selection.select(this.colorRangesGroup, _Scene49.Rect, false);
    this.rootGroup.append(this.colorRangesGroup);
    this.targetLinesSelection = _Scene49.Selection.select(this.annotationGroup, _Scene49.Line, false);
  }
  destroy() {
  ...
  async createNodeData() {
    ...
    for (const { datum, values } of processedData.data) {
      ...
      if (values[0][valueIndex] < 0) {
        _Util57.Logger.warnOnce("negative values are not supported, clipping to 0.");
      }
      ...
      const barAlongX = this.getBarDirection() === _ModuleSupport83.ChartAxisDirection.X;
      const rect = {
      ...
      if (values[0][targetIndex] < 0) {
        _Util57.Logger.warnOnce("negative targets are not supported, ignoring.");
      }
  ...
  getTooltipHtml(nodeDatum) {
    ...
    if (valueKey === void 0 || valueValue === void 0 || axis === void 0) {
      return _ModuleSupport83.EMPTY_TOOLTIP_CONTENT;
    }
  ...
  async updateColorRanges() {
    ...
    const computeRect = this.getBarDirection() === _ModuleSupport83.ChartAxisDirection.Y ? (rect, colorRange) => {
      rect.x = min;
...
var { computeBarFocusBounds: computeBarFocusBounds3, NODE_UPDATE_STATE_TO_PHASE_MAPPING } = _ModuleSupport85;
...
var { sanitizeHtml: sanitizeHtml2, Logger: Logger6 } = _Util58;
var { ContinuousScale: ContinuousScale2 } = _Scale10;
var CandlestickSeriesNodeEvent = class extends _ModuleSupport86.SeriesNodeEvent {
  constructor(type, nativeEvent, datum, series) {
    super(type, nativeEvent, datum, series);
    this.xKey = series.properties.xKey;
...
var OhlcSeriesBase = class extends _ModuleSupport86.AbstractBarSeries {
  ...
  getTooltipHtml(nodeDatum) {
    ...
    const yAxis = this.getValueAxis();
    if (!xAxis || !yAxis || !this.properties.isValid())
      return _ModuleSupport86.EMPTY_TOOLTIP_CONTENT;
...
import { _ModuleSupport as _ModuleSupport87, _Scene as _Scene51, _Util as _Util59 } from "ag-charts-community";
var { SceneChangeDetection, BBox: BBox6, RedrawType } = _Scene51;
var CandlestickBaseGroup = class extends _Scene51.Group {
  constructor() {
    super(...arguments);
    this.x = 0;
    this.y = 0;
  ...
  distanceSquared(x, y) {
    const nodes = _Scene51.Selection.selectByClass(this, _Scene51.Rect, _Scene51.Line);
    return _ModuleSupport87.nearestSquared(x, y, nodes).distanceSquared;
  }
  get midPoint() {
    const datum = this.datum;
    if (datum.midPoint === void 0) {
      _Util59.Logger.error("CandlestickBaseGroup.datum.midPoint is undefined");
      return { x: NaN, y: NaN };
    }
    return datum.midPoint;
  }
...
var CandlestickGroup = class extends CandlestickBaseGroup {
  constructor() {
    super();
    this.append([
      new _Scene51.Rect({ tag: 0 /* Body */ }),
      new _Scene51.Line({ tag: 1 /* LowWick */ }),
      new _Scene51.Line({ tag: 2 /* HighWick */ })
    ]);
  }
  updateCoordinates() {
    const { x, y, yBottom, yHigh, yLow, width, height } = this;
    const selection = _Scene51.Selection.select(this, _Scene51.Rect);
...
// packages/ag-charts-enterprise/src/series/candlestick/candlestickSeries.ts
var { extractDecoratedProperties: extractDecoratedProperties2, mergeDefaults: mergeDefaults5 } = _ModuleSupport89;
...
import { _ModuleSupport as _ModuleSupport90, _Scene as _Scene53 } from "ag-charts-community";

// packages/ag-charts-enterprise/src/series/flow-proportion/flowProportionUtil.ts
import { _Util as _Util60 } from "ag-charts-community";
var { Logger: Logger7 } = _Util60;
...
// packages/ag-charts-enterprise/src/series/flow-proportion/flowProportionSeries.ts
var { DataModelSeries, DataController, Validate: Validate43, ARRAY: ARRAY4, keyProperty: keyProperty4, valueProperty: valueProperty6 } = _ModuleSupport90;
var { Selection: Selection3, Group: Group8, Text: Text5 } = _Scene53;
...
var { BBox: BBox7, Path: Path5, ScenePathChangeDetection } = _Scene54;
...
import {
  _ModuleSupport as _ModuleSupport91,
  _Scene as _Scene55
} from "ag-charts-community";
var {
...
// packages/ag-charts-enterprise/src/series/chord/chordSeries.ts
var { SeriesNodePickMode: SeriesNodePickMode3, CachedTextMeasurerPool: CachedTextMeasurerPool4, TextWrapper: TextWrapper5, createDatumId: createDatumId2, EMPTY_TOOLTIP_CONTENT } = _ModuleSupport92;
var { angleBetween: angleBetween3, normalizeAngle360: normalizeAngle3605, isBetweenAngles, sanitizeHtml: sanitizeHtml3, Logger: Logger8 } = _Util62;
var { Sector: Sector3, Text: Text6, evaluateBezier } = _Scene56;
...
import { _ModuleSupport as _ModuleSupport97, _Scale as _Scale11, _Scene as _Scene58, _Util as _Util64 } from "ag-charts-community";

// packages/ag-charts-enterprise/src/series/util/labelFormatter.ts
import { _ModuleSupport as _ModuleSupport94, _Util as _Util63 } from "ag-charts-community";
var { CachedTextMeasurerPool: CachedTextMeasurerPool5, TextUtils: TextUtils3, TextWrapper: TextWrapper6, findMaxValue } = _ModuleSupport94;
var { Logger: Logger9 } = _Util63;
...
import { _ModuleSupport as _ModuleSupport95, _Scene as _Scene57 } from "ag-charts-community";
var { Validate: Validate45, NUMBER: NUMBER11, TEXT_WRAP, OVERFLOW_STRATEGY } = _ModuleSupport95;
var BaseAutoSizedLabel = class extends _Scene57.Label {
  constructor() {
    super(...arguments);
...
var { Rect: Rect3, PointerEvents } = _Scene58;
var { ColorScale } = _Scale11;
var { sanitizeHtml: sanitizeHtml4, Logger: Logger10 } = _Util64;
var HeatmapSeriesNodeEvent = class extends _ModuleSupport97.CartesianSeriesNodeEvent {
  constructor(type, nativeEvent, datum, series) {
    super(type, nativeEvent, datum, series);
...
var HeatmapSeries = class extends _ModuleSupport97.CartesianSeries {
  constructor(moduleCtx) {
    super({
      moduleCtx,
...
import { _ModuleSupport as _ModuleSupport102, _Scene as _Scene60, _Util as _Util65 } from "ag-charts-community";

// packages/ag-charts-enterprise/src/series/map-util/geoGeometry.ts
import { _Scene as _Scene59 } from "ag-charts-community";
...
var { LonLatBBox } = _ModuleSupport98;
...
// packages/ag-charts-enterprise/src/series/map-util/geoGeometry.ts
var { Path: Path6, ExtendedPath2D, BBox: BBox8, ScenePathChangeDetection: ScenePathChangeDetection2 } = _Scene59;
...
function isValidCoordinate(v) {
  return Array.isArray(v) && v.length >= 2 && v.every(_ModuleSupport100.isFiniteNumber);
}
...
var GEOJSON_OBJECT = _ModuleSupport100.predicateWithMessage(isValidFeatureCollection, "a GeoJSON object");
...
var { COLOR_STRING: COLOR_STRING12, LINE_DASH: LINE_DASH9, OBJECT: OBJECT18, POSITIVE_NUMBER: POSITIVE_NUMBER15, RATIO: RATIO17, Validate: Validate47, SeriesProperties: SeriesProperties2, SeriesTooltip: SeriesTooltip6 } = _ModuleSupport101;
...
// packages/ag-charts-enterprise/src/series/map-line-background/mapLineBackgroundSeries.ts
var { createDatumId: createDatumId3, DataModelSeries: DataModelSeries2, SeriesNodePickMode: SeriesNodePickMode5, Validate: Validate48 } = _ModuleSupport102;
var { Group: Group9, Selection: Selection4, PointerEvents: PointerEvents2 } = _Scene60;
var { Logger: Logger11 } = _Util65;
var MapLineBackgroundSeries = class extends DataModelSeries2 {
  ...
  getTooltipHtml() {
    return _ModuleSupport102.EMPTY_TOOLTIP_CONTENT;
  }
...
// packages/ag-charts-enterprise/src/series/map-line-background/mapLineBackgroundModule.ts
var { DEFAULT_HIERARCHY_STROKES } = _Theme18;
...
import { _ModuleSupport as _ModuleSupport105, _Scale as _Scale12, _Scene as _Scene62, _Util as _Util67 } from "ag-charts-community";
...
import { _ModuleSupport as _ModuleSupport104, _Scene as _Scene61 } from "ag-charts-community";
var {
  AND: AND8,
  ARRAY: ARRAY7,
...
var { ColorScale: ColorScale2, LinearScale: LinearScale3 } = _Scale12;
var { Selection: Selection5, Text: Text7 } = _Scene62;
var { sanitizeHtml: sanitizeHtml5, Logger: Logger12 } = _Util67;
var MapLineSeries = class extends DataModelSeries3 {
  ...
  getTooltipHtml(nodeDatum) {
    ...
    if (!processedData || !properties.isValid()) {
      return _ModuleSupport105.EMPTY_TOOLTIP_CONTENT;
    }
    const {
      legendItemName,
      idKey,
...
// packages/ag-charts-enterprise/src/series/map-line/mapLineModule.ts
var { DEFAULT_DIVERGING_SERIES_COLOUR_RANGE, DEFAULT_FONT_FAMILY: DEFAULT_FONT_FAMILY2, DEFAULT_LABEL_COLOUR: DEFAULT_LABEL_COLOUR2, singleSeriesPaletteFactory } = _Theme19;
var MapLineModule = {
  type: "series",
  optionsKey: "series[]",
  packageType: "enterprise",
...
import { _ModuleSupport as _ModuleSupport108, _Scale as _Scale13, _Scene as _Scene64, _Util as _Util69 } from "ag-charts-community";
...
import { _ModuleSupport as _ModuleSupport107, _Scene as _Scene63, _Util as _Util68 } from "ag-charts-community";
var {
  AND: AND9,
  ARRAY: ARRAY8,
...
var { Label: Label5, Circle } = _Scene63;
var { Logger: Logger13 } = _Util68;
...
var { ColorScale: ColorScale3, LinearScale: LinearScale4 } = _Scale13;
var { Group: Group10, Selection: Selection6, Text: Text8, getMarker } = _Scene64;
var { sanitizeHtml: sanitizeHtml6, Logger: Logger14 } = _Util69;
...
// packages/ag-charts-enterprise/src/series/map-marker/mapMarkerModule.ts
var { DEFAULT_LABEL_COLOUR: DEFAULT_LABEL_COLOUR3, DEFAULT_DIVERGING_SERIES_COLOUR_RANGE: DEFAULT_DIVERGING_SERIES_COLOUR_RANGE2, singleSeriesPaletteFactory: singleSeriesPaletteFactory2 } = _Theme20;
var MapMarkerModule = {
  type: "series",
  optionsKey: "series[]",
  packageType: "enterprise",
...
import { _ModuleSupport as _ModuleSupport111, _Scene as _Scene65, _Util as _Util70 } from "ag-charts-community";
...
var { COLOR_STRING: COLOR_STRING15, LINE_DASH: LINE_DASH11, OBJECT: OBJECT21, POSITIVE_NUMBER: POSITIVE_NUMBER18, RATIO: RATIO20, Validate: Validate53, SeriesProperties: SeriesProperties5, SeriesTooltip: SeriesTooltip9 } = _ModuleSupport110;
...
// packages/ag-charts-enterprise/src/series/map-shape-background/mapShapeBackgroundSeries.ts
var { createDatumId: createDatumId6, Series, SeriesNodePickMode: SeriesNodePickMode8, Validate: Validate54 } = _ModuleSupport111;
var { Selection: Selection7, Group: Group11, PointerEvents: PointerEvents3 } = _Scene65;
var { Logger: Logger15 } = _Util70;
var MapShapeBackgroundSeries = class extends Series {
  ...
  getTooltipHtml() {
    return _ModuleSupport111.EMPTY_TOOLTIP_CONTENT;
  }
  pickFocus(_opts) {
    return void 0;
  }
...
import { _ModuleSupport as _ModuleSupport114, _Scale as _Scale15, _Scene as _Scene67, _Util as _Util72 } from "ag-charts-community";
...
var { ColorScale: ColorScale4 } = _Scale15;
var { Group: Group12, Selection: Selection8, Text: Text9, PointerEvents: PointerEvents4 } = _Scene67;
var { sanitizeHtml: sanitizeHtml7, Logger: Logger16 } = _Util72;
var fixedScale = _ModuleSupport114.MercatorScale.fixedScale();
var MapShapeSeries = class extends DataModelSeries5 {
  ...
  getTooltipHtml(nodeDatum) {
    ...
    if (!processedData || !properties.isValid()) {
      return _ModuleSupport114.EMPTY_TOOLTIP_CONTENT;
    }
    const {
      legendItemName,
      idKey,
...
import { _Scene as _Scene72 } from "ag-charts-community";

// packages/ag-charts-enterprise/src/series/radial-column/radialColumnSeriesBase.ts
import { _ModuleSupport as _ModuleSupport116, _Scale as _Scale16, _Scene as _Scene68, _Util as _Util73 } from "ag-charts-community";
var {
...
var { BandScale: BandScale3 } = _Scale16;
var { motion: motion3 } = _Scene68;
var { isNumber, normalizeAngle360: normalizeAngle3606, sanitizeHtml: sanitizeHtml8 } = _Util73;
var RadialColumnSeriesNodeEvent = class extends _ModuleSupport116.SeriesNodeEvent {
  constructor(type, nativeEvent, datum, series) {
    super(type, nativeEvent, datum, series);
...
var RadialColumnSeriesBase = class extends _ModuleSupport116.PolarSeries {
  constructor(moduleCtx, {
    animationResetFns
  }) {
    super({
  ...
  getTooltipHtml(nodeDatum) {
    ...
    if (!this.properties.isValid() || !(xAxis && yAxis && isNumber(radiusValue)) || !dataModel) {
      return _ModuleSupport116.EMPTY_TOOLTIP_CONTENT;
    }
...
import { _ModuleSupport as _ModuleSupport117, _Scene as _Scene69 } from "ag-charts-community";
var { Label: Label6 } = _Scene69;
var {
...
import { _Scene as _Scene71 } from "ag-charts-community";

// packages/ag-charts-enterprise/src/series/radial-column/radialColumnUtil.ts
import { _Scene as _Scene70 } from "ag-charts-community";
var { motion: motion4 } = _Scene70;
...
// packages/ag-charts-enterprise/src/series/nightingale/nightingaleUtil.ts
var { SectorBox, motion: motion5 } = _Scene71;
...
// packages/ag-charts-enterprise/src/series/nightingale/nightingaleSeries.ts
var { Sector: Sector4, SectorBox: SectorBox2 } = _Scene72;
...
var NightingaleModule = {
  ...
  paletteFactory({ takeColors, userPalette }) {
    ...
    return {
      fill,
      stroke: userPalette !== "inbuilt" ? stroke : _Theme24.DEFAULT_POLAR_SERIES_STROKE
    };
  },
  stackable: true,
  groupable: true,
...
import { _Scene as _Scene73 } from "ag-charts-community";
var OhlcGroup = class extends CandlestickBaseGroup {
  constructor() {
    super();
    this.append([
      new _Scene73.Line({ tag: 0 /* Body */ }),
      new _Scene73.Line({ tag: 1 /* Open */ }),
      new _Scene73.Line({ tag: 2 /* Close */ })
    ]);
  }
  updateCoordinates() {
    const {
    ...
    const selection = _Scene73.Selection.select(this, _Scene73.Rect);
    const [body] = selection.selectByTag(0 /* Body */);
...
var { BaseProperties: BaseProperties19, Validate: Validate58, COLOR_STRING: COLOR_STRING18, FUNCTION: FUNCTION13, LINE_DASH: LINE_DASH14, OBJECT: OBJECT24, POSITIVE_NUMBER: POSITIVE_NUMBER21, RATIO: RATIO23 } = _ModuleSupport120;
...
// packages/ag-charts-enterprise/src/series/ohlc/ohlcSeries.ts
var { mergeDefaults: mergeDefaults7 } = _ModuleSupport121;
...
var OhlcModule = {
  ...
  defaultAxes: [
    {
      type: _Theme25.CARTESIAN_AXIS_TYPE.NUMBER,
      position: _Theme25.POSITION.LEFT
    },
    {
      type: _Theme25.CARTESIAN_AXIS_TYPE.ORDINAL_TIME,
      position: _Theme25.POSITION.BOTTOM
    }
  ],
  themeTemplate: {
    animation: { enabled: false },
...
import { _ModuleSupport as _ModuleSupport127, _Theme as _Theme27 } from "ag-charts-community";

// packages/ag-charts-enterprise/src/series/radar/radarThemes.ts
import { _ModuleSupport as _ModuleSupport122, _Theme as _Theme26 } from "ag-charts-community";
var BASE_RADAR_SERIES_THEME = {
  series: {
    label: {
      enabled: false,
      fontSize: 12,
      fontFamily: _Theme26.DEFAULT_FONT_FAMILY,
      color: _Theme26.DEFAULT_LABEL_COLOUR
    },
    marker: {
      enabled: true,
      fillOpacity: 1,
  ...
  axes: {
    [_Theme26.POLAR_AXIS_TYPE.ANGLE_CATEGORY]: {
      label: {
        padding: 10
      }
    }
...
var RADAR_LINE_SERIES_THEME = _ModuleSupport122.mergeDefaults(
  {
    series: {
      strokeWidth: 2
    }
...
var RADAR_AREA_SERIES_THEME = _ModuleSupport122.mergeDefaults(
  {
    series: {
      fillOpacity: 0.8,
      strokeWidth: 2,
...
import { _ModuleSupport as _ModuleSupport126, _Scene as _Scene77 } from "ag-charts-community";

// packages/ag-charts-enterprise/src/series/radar/radarSeries.ts
import { _ModuleSupport as _ModuleSupport124, _Scene as _Scene76, _Util as _Util75 } from "ag-charts-community";

// packages/ag-charts-enterprise/src/series/radar/radarSeriesProperties.ts
import { _ModuleSupport as _ModuleSupport123, _Scene as _Scene75 } from "ag-charts-community";
var { Label: Label7 } = _Scene75;
var {
  SeriesMarker,
...
var { BBox: BBox9, Group: Group13, Path: Path7, PointerEvents: PointerEvents5, Selection: Selection9, Text: Text10, getMarker: getMarker2 } = _Scene76;
var { extent: extent3, isNumberEqual: isNumberEqual8, sanitizeHtml: sanitizeHtml9, toFixed } = _Util75;
var RadarSeriesNodeEvent = class extends _ModuleSupport124.SeriesNodeEvent {
  constructor(type, nativeEvent, datum, series) {
    super(type, nativeEvent, datum, series);
    this.angleKey = series.properties.angleKey;
    this.radiusKey = series.properties.radiusKey;
...
var RadarSeries = class extends _ModuleSupport124.PolarSeries {
  constructor(moduleCtx) {
    super({
      moduleCtx,
      useLabelLayer: true,
  ...
  async createNodeData() {
    ...
    const nodeData = processedData.data.map((group) => {
      ...
      return {
        ...
        angleValue: angleDatum,
        radiusValue: radiusDatum,
        missing: !_Util75.isNumber(angle) || !_Util75.isNumber(radius)
      };
    });
    return { itemId: radiusKey, nodeData, labelData: nodeData };
  }
  ...
  getTooltipHtml(nodeDatum) {
    if (!this.properties.isValid()) {
      return _ModuleSupport124.EMPTY_TOOLTIP_CONTENT;
    }
...
var { RATIO: RATIO25, COLOR_STRING: COLOR_STRING20, Validate: Validate60 } = _ModuleSupport125;
...
// packages/ag-charts-enterprise/src/series/radar-area/radarAreaSeries.ts
var { Group: Group14, Path: Path8, PointerEvents: PointerEvents6, Selection: Selection10 } = _Scene77;
var { ChartAxisDirection: ChartAxisDirection17 } = _ModuleSupport126;
var RadarAreaSeries = class extends RadarSeries {
  ...
  getAreaPoints() {
    ...
    const getPolarAxis = (direction) => {
      ...
      return axis instanceof _ModuleSupport126.PolarAxis ? axis : void 0;
    };
...
// packages/ag-charts-enterprise/src/series/radar-area/radarAreaModule.ts
var { markerPaletteFactory } = _ModuleSupport127;
var RadarAreaModule = {
  type: "series",
  optionsKey: "series[]",
  packageType: "enterprise",
  ...
  defaultAxes: [
    {
      type: _Theme27.POLAR_AXIS_TYPE.ANGLE_CATEGORY
    },
    {
      type: _Theme27.POLAR_AXIS_TYPE.RADIUS_NUMBER
    }
  ],
...
import { _ModuleSupport as _ModuleSupport129, _Scale as _Scale17, _Scene as _Scene80, _Util as _Util76 } from "ag-charts-community";

// packages/ag-charts-enterprise/src/series/radial-bar/radialBarSeriesProperties.ts
import { _ModuleSupport as _ModuleSupport128, _Scene as _Scene78 } from "ag-charts-community";
var { Label: Label8 } = _Scene78;
var {
...
var { SectorBox: SectorBox3, motion: motion6 } = _Scene79;
...
var { BandScale: BandScale4 } = _Scale17;
var { Sector: Sector5, SectorBox: SectorBox4, motion: motion7 } = _Scene80;
var { angleBetween: angleBetween4, isNumber: isNumber2, sanitizeHtml: sanitizeHtml10 } = _Util76;
var RadialBarSeriesNodeEvent = class extends _ModuleSupport129.SeriesNodeEvent {
  constructor(type, nativeEvent, datum, series) {
    super(type, nativeEvent, datum, series);
    this.angleKey = series.properties.angleKey;
    this.radiusKey = series.properties.radiusKey;
...
var RadialBarSeries = class extends _ModuleSupport129.PolarSeries {
  constructor(moduleCtx) {
    super({
      moduleCtx,
      useLabelLayer: true,
  ...
  getTooltipHtml(nodeDatum) {
    ...
    if (!this.properties.isValid() || !(xAxis && yAxis && isNumber2(angleValue)) || !dataModel) {
      return _ModuleSupport129.EMPTY_TOOLTIP_CONTENT;
    }
    const angleString = xAxis.formatDatum(angleValue);
    const radiusString = yAxis.formatDatum(radiusValue);
...
var RADIAL_BAR_SERIES_THEME = {
  series: {
    ...
    label: {
      enabled: false,
      fontSize: 12,
      fontFamily: _Theme29.DEFAULT_FONT_FAMILY,
      color: _Theme29.DEFAULT_INVERTED_LABEL_COLOUR
    }
  },
  axes: {
    [_Theme29.POLAR_AXIS_TYPE.RADIUS_CATEGORY]: {
...
var RadialBarModule = {
  ...
  defaultAxes: [
    {
      type: _Theme30.POLAR_AXIS_TYPE.ANGLE_NUMBER
    },
    {
      type: _Theme30.POLAR_AXIS_TYPE.RADIUS_CATEGORY
    }
  ],
...
import { _ModuleSupport as _ModuleSupport131, _Scene as _Scene81 } from "ag-charts-community";
...
var { Validate: Validate62, RATIO: RATIO27 } = _ModuleSupport130;
...
// packages/ag-charts-enterprise/src/series/radial-column/radialColumnSeries.ts
var { ChartAxisDirection: ChartAxisDirection19, PolarAxis: PolarAxis4 } = _ModuleSupport131;
var { RadialColumnShape, getRadialColumnWidth } = _Scene81;
...
var RADIAL_COLUMN_SERIES_THEME = {
  series: {
    ...
    label: {
      enabled: false,
      fontSize: 12,
      fontFamily: _Theme31.DEFAULT_FONT_FAMILY,
      color: _Theme31.DEFAULT_LABEL_COLOUR
    }
  },
  axes: {
    [_Theme31.POLAR_AXIS_TYPE.ANGLE_CATEGORY]: {
      shape: _Theme31.POLAR_AXIS_SHAPE.CIRCLE,
      groupPaddingInner: 0,
      paddingInner: 0,
      label: {
        padding: 10
    ...
    [_Theme31.POLAR_AXIS_TYPE.RADIUS_NUMBER]: {
      shape: _Theme31.POLAR_AXIS_SHAPE.CIRCLE,
...
var RadialColumnModule = {
  ...
  defaultAxes: [
    {
      type: _Theme32.POLAR_AXIS_TYPE.ANGLE_CATEGORY
    },
    {
      type: _Theme32.POLAR_AXIS_TYPE.RADIUS_NUMBER
    }
  ],
...
import { _ModuleSupport as _ModuleSupport134, _Theme as _Theme34 } from "ag-charts-community";

// packages/ag-charts-enterprise/src/series/range-area/rangeArea.ts
import { _ModuleSupport as _ModuleSupport133, _Scene as _Scene83, _Util as _Util77 } from "ag-charts-community";

// packages/ag-charts-enterprise/src/series/range-area/rangeAreaProperties.ts
import { _ModuleSupport as _ModuleSupport132, _Scene as _Scene82 } from "ag-charts-community";
var { DropShadow, Label: Label9 } = _Scene82;
var {
...
var { getMarker: getMarker3, PointerEvents: PointerEvents7 } = _Scene83;
var { sanitizeHtml: sanitizeHtml11, extent: extent4 } = _Util77;
var RangeAreaSeriesNodeEvent = class extends _ModuleSupport133.SeriesNodeEvent {
  constructor(type, nativeEvent, datum, series) {
    super(type, nativeEvent, datum, series);
    this.xKey = series.properties.xKey;
...
var RangeAreaSeries = class extends _ModuleSupport133.CartesianSeries {
  constructor(moduleCtx) {
    super({
      moduleCtx,
      hasMarkers: true,
  ...
  computeFocusBounds(opts) {
    ...
    if (hiBox && loBox) {
      return _Scene83.BBox.merge([hiBox, loBox]);
    }
    return void 0;
  }
};
...
var RANGE_AREA_SERIES_THEME = {
  series: {
    ...
    label: {
      ...
      padding: 10,
      fontSize: 12,
      fontFamily: _Theme33.DEFAULT_FONT_FAMILY,
      color: _Theme33.DEFAULT_LABEL_COLOUR
    },
    interpolation: {
      type: "linear",
  ...
  axes: {
    [_Theme33.CARTESIAN_AXIS_TYPE.NUMBER]: {
...
// packages/ag-charts-enterprise/src/series/range-area/rangeAreaModule.ts
var { markerPaletteFactory: markerPaletteFactory2 } = _ModuleSupport134;
var RangeAreaModule = {
  type: "series",
  optionsKey: "series[]",
  packageType: "enterprise",
  ...
  defaultAxes: [
    {
      type: _Theme34.CARTESIAN_AXIS_TYPE.NUMBER,
      position: _Theme34.POSITION.LEFT
    },
    {
      type: _Theme34.CARTESIAN_AXIS_TYPE.CATEGORY,
      position: _Theme34.POSITION.BOTTOM
    }
  ],
...
import { _ModuleSupport as _ModuleSupport136, _Scale as _Scale18, _Scene as _Scene85, _Util as _Util78 } from "ag-charts-community";

// packages/ag-charts-enterprise/src/series/range-bar/rangeBarProperties.ts
import { _ModuleSupport as _ModuleSupport135, _Scene as _Scene84 } from "ag-charts-community";
var { DropShadow: DropShadow2, Label: Label10 } = _Scene84;
var {
...
var { Rect: Rect4, PointerEvents: PointerEvents8, motion: motion8 } = _Scene85;
var { sanitizeHtml: sanitizeHtml12, isNumber: isNumber3, extent: extent5 } = _Util78;
var { ContinuousScale: ContinuousScale3 } = _Scale18;
var RangeBarSeriesNodeEvent = class extends _ModuleSupport136.SeriesNodeEvent {
  constructor(type, nativeEvent, datum, series) {
    super(type, nativeEvent, datum, series);
    this.xKey = series.properties.xKey;
    this.yLowKey = series.properties.yLowKey;
...
var RangeBarSeries = class extends _ModuleSupport136.AbstractBarSeries {
  constructor(moduleCtx) {
    super({
      moduleCtx,
  ...
  async createNodeData() {
    ...
    processedData?.data.forEach(({ keys, datum, values }, dataIndex) => {
      values.forEach((value, valueIndex) => {
        ...
        if (!_Util78.isNumber(rawHighValue) || !_Util78.isNumber(rawLowValue)) {
          return;
        }
  ...
  getTooltipHtml(nodeDatum) {
    ...
    const yAxis = this.getValueAxis();
    if (!this.properties.isValid() || !xAxis || !yAxis) {
      return _ModuleSupport136.EMPTY_TOOLTIP_CONTENT;
    }
    const {
      xKey,
      yLowKey,
...
var RANGE_BAR_SERIES_THEME = {
  series: {
    ...
    label: {
      ...
      color: _Theme35.DEFAULT_INSIDE_SERIES_LABEL_COLOUR,
      placement: "inside"
    }
  },
  axes: {
...
import { _Scene as _Scene86 } from "ag-charts-community";
var { BBox: BBox10, Path: Path9, ScenePathChangeDetection: ScenePathChangeDetection3, splitBezier } = _Scene86;
...
import {
  _ModuleSupport as _ModuleSupport137,
  _Scene as _Scene87
} from "ag-charts-community";
var {
...
// packages/ag-charts-enterprise/src/series/sankey/sankeySeries.ts
var { SeriesNodePickMode: SeriesNodePickMode13, CachedTextMeasurerPool: CachedTextMeasurerPool9, TextWrapper: TextWrapper7, createDatumId: createDatumId9, EMPTY_TOOLTIP_CONTENT: EMPTY_TOOLTIP_CONTENT2 } = _ModuleSupport138;
var { sanitizeHtml: sanitizeHtml13 } = _Util80;
var { Rect: Rect5, Text: Text11, BBox: BBox11 } = _Scene88;
...
// packages/ag-charts-enterprise/src/series/sankey/sankeyModule.ts
var { DEFAULT_FONT_FAMILY: DEFAULT_FONT_FAMILY3, DEFAULT_LABEL_COLOUR: DEFAULT_LABEL_COLOUR4 } = _Theme37;
var SankeyModule = {
  type: "series",
  optionsKey: "series[]",
  packageType: "enterprise",
...
import { _ModuleSupport as _ModuleSupport140, _Scene as _Scene89, _Util as _Util81 } from "ag-charts-community";
...
// packages/ag-charts-enterprise/src/series/sunburst/sunburstSeries.ts
var { fromToMotion: fromToMotion3 } = _ModuleSupport140;
var { Sector: Sector6, Group: Group15, Selection: Selection11, Text: Text12 } = _Scene89;
var { sanitizeHtml: sanitizeHtml14 } = _Util81;
...
var SunburstSeries = class extends _ModuleSupport140.HierarchySeries {
  constructor() {
    super(...arguments);
  ...
  async updateNodes() {
    ...
    const labelMeta = Array.from(this.rootNode, (node, index) => {
      ...
      const sizeFittingHeight = (labelHeight2) => {
        ...
        } else if (_Util81.normalizeAngle360(deltaInnerAngle) < maxPerpendicularAngle) {
  ...
  getTooltipHtml(node) {
    ...
    if (datum == null || depth == null) {
      return _ModuleSupport140.EMPTY_TOOLTIP_CONTENT;
    }
  ...
  computeFocusBounds(nodeDatum) {
    ...
    for (const { node, datum } of this.groupSelection) {
      if (datum === nodeDatum) {
        match = _Scene89.Selection.selectByClass(node, _Scene89.Sector)[0];
      }
    }
    return match;
  }
...
// packages/ag-charts-enterprise/src/series/sunburst/sunburstModule.ts
var { DEFAULT_INSIDE_SERIES_LABEL_COLOUR } = _Theme38;
var SunburstModule = {
  type: "series",
  optionsKey: "series[]",
  packageType: "enterprise",
  ...
  paletteFactory: ({ takeColors, colorsCount, themeTemplateParameters }) => {
    const { fills, strokes } = takeColors(colorsCount);
    const defaultColorRange = themeTemplateParameters.get(_Theme38.DEFAULT_DIVERGING_SERIES_COLOUR_RANGE);
...
import {
  _ModuleSupport as _ModuleSupport142,
  _Scene as _Scene91,
  _Util as _Util82
} from "ag-charts-community";

// packages/ag-charts-enterprise/src/series/treemap/treemapSeriesProperties.ts
import { _ModuleSupport as _ModuleSupport141, _Scene as _Scene90 } from "ag-charts-community";
var { Label: Label12 } = _Scene90;
var {
...
// packages/ag-charts-enterprise/src/series/treemap/treemapSeries.ts
var { TextUtils: TextUtils5, TextWrapper: TextWrapper8 } = _ModuleSupport142;
var { Rect: Rect6, Group: Group16, BBox: BBox12, Selection: Selection12, Text: Text13 } = _Scene91;
var { Color: Color7, Logger: Logger17, clamp: clamp5, isEqual: isEqual2, sanitizeHtml: sanitizeHtml15 } = _Util82;
...
var DistantGroup = class extends _Scene91.Group {
  distanceSquared(x, y) {
    return this.getBBox().distanceSquared(x, y);
  }
};
var TreemapSeries = class extends _ModuleSupport142.HierarchySeries {
  constructor() {
    super(...arguments);
  ...
  getTooltipHtml(node) {
    ...
    if (datum == null || depth == null || !interactive) {
      return _ModuleSupport142.EMPTY_TOOLTIP_CONTENT;
    }
    const title = labelKey != null ? datum[labelKey] : void 0;
...
import { _ModuleSupport as _ModuleSupport144, _Scale as _Scale19, _Scene as _Scene93, _Util as _Util83 } from "ag-charts-community";

// packages/ag-charts-enterprise/src/series/waterfall/waterfallSeriesProperties.ts
import { _ModuleSupport as _ModuleSupport143, _Scene as _Scene92 } from "ag-charts-community";
var { DropShadow: DropShadow3, Label: Label13 } = _Scene92;
var {
...
var { Rect: Rect7, motion: motion9 } = _Scene93;
var { sanitizeHtml: sanitizeHtml16, isContinuous } = _Util83;
var { ContinuousScale: ContinuousScale4 } = _Scale19;
var WaterfallSeries = class extends _ModuleSupport144.AbstractBarSeries {
  constructor(moduleCtx) {
    super({
      moduleCtx,
  ...
  async processData(dataController) {
    ...
    const { processedData } = await this.requestDataModel(dataController, dataWithTotals, {
      props: [
        ...
        ...isContinuousX ? [_ModuleSupport144.SMALLEST_KEY_INTERVAL, _ModuleSupport144.LARGEST_KEY_INTERVAL] : [],
        ...extraProps
      ]
    });
    this.smallestDataInterval = processedData.reduced?.smallestKeyInterval;
  ...
  getSeriesDomain(direction) {
    ...
    if (direction === this.getCategoryDirection()) {
      ...
      const keysExtent = _ModuleSupport144.extent(keys) ?? [NaN, NaN];
      const categoryAxis = this.getCategoryAxis();
  ...
  getTooltipHtml(nodeDatum) {
    ...
    if (!this.properties.isValid() || !categoryAxis || !valueAxis) {
      return _ModuleSupport144.EMPTY_TOOLTIP_CONTENT;
    }
    const { id: seriesId } = this;
  ...
  animateConnectorLinesHorizontal(lineNode, pointData) {
    ...
    this.ctx.animationManager.animate({
      ...
      from: startX,
      to: endX,
      ease: _ModuleSupport144.Motion.easeOut,
      collapsable: false,
      onUpdate(pointX) {
        linePath.clear(true);
  ...
  updateLineNode(lineNode) {
    ...
    lineNode.setProperties({
      ...
      lineDashOffset,
      lineJoin: "round",
      pointerEvents: _Scene93.PointerEvents.None
    });
  }
  isLabelEnabled() {
...
var WATERFALL_SERIES_THEME = {
  series: {
    ...
    line: {
      stroke: _Theme40.PALETTE_NEUTRAL_STROKE,
      strokeOpacity: 1,
      lineDash: [0],
      lineDashOffset: 0,
      strokeWidth: 2
    ...
    return {
      ...
      item: {
        positive: {
          ...
          label: {
            color: _Theme41.DEFAULT_LABEL_COLOUR
          }
        },
        negative: {
...
function setupEnterpriseModules() {
  _ModuleSupport145.moduleRegistry.register(
  ...
  _ModuleSupport145.enterpriseModule.isEnterprise = true;
  _ModuleSupport145.enterpriseModule.styles = styles_default;
  _ModuleSupport145.enterpriseModule.licenseManager = (options) => new LicenseManager(
    options.container?.ownerDocument ?? (typeof document === "undefined" ? void 0 : document)
  );
  _ModuleSupport145.enterpriseModule.injectWatermark = injectWatermark;
}
