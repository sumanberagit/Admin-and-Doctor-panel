        ...
        <div className="sm:col-span-2 flex flex-col sm:flex-row justify-center items-center">
          <div className="flex flex-col items-center text-center mb-4 sm:mb-0 sm:mr-6">
            ...
            <div>
              ...
              <p className="text-gray-600">Great doctor if you need your family member to get effective immediate assistance</p>
              <a href="tel:+152534468854" className="text-blue-600">+152 534-468-854</a>
            </div>
          </div>
